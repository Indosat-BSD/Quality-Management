...
<?
		...
		/*/
			...
			values('$customer_name','$msisdn','$interaction_date','$observation_date','$hh_2','$mm_2','$ss_2','$week_','$interaction_type','$product_knowledge','$notes_pk','$activity_code','$notes_ac','$handling_process','$fcr','$notes_fcr','$repetitive_call','$notes_repeat','$anthusiasm','$notes_anthusiasm','$manner','$notes_manner','$effective_handling','$notes_eh','$kd_region','$pribadi','$kd_unit','$SES_hendi','$nTL','$date_saved')";
			  $simpan_data=mssql_query($q_addTemp);
