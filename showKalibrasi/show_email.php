...
<?
$q_user="select * from table_kalibrasi_email a inner join table_qm_email_detail b on a.id_qm=b.id_qm where a.id_qm='$id_qm'";
					//echo"$q_user";
...
NA</td>
      <td><textarea name="notes13" cols="35" id="notes13" onKeyPress="javascript: checkValuenotes13();" disabled="disabled" ><? if($cancel){ ?><? $notes13="";}?><? echo "$notes13"; ?></textarea>
...
NA</td>
      <td><textarea name="notes14" cols="35" id="notes14" onKeyPress="javascript: checkValuenotes14();" disabled="disabled" ><? if($cancel){ ?><? $notes14="";}?><? echo "$notes13"; ?></textarea>
