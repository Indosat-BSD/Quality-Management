...
$q_user="select * from table_kalibrasi_galeri a inner join table_qm_galeri_detail b on a.id_qm=b.id_qm where a.id_qm='$id_qm'";
...
<thead>
  ...
  NA</td>
      <td><textarea disabled="disabled"  name="notes13" cols="35" id="notes13" onKeyPress="javascript: checkValuenotes13();"><? if($cancel){ ?><? $notes1="";}?><? echo "$notes13"; ?></textarea>
  ...
  NA</td>
      <td><textarea disabled="disabled"  name="notes14" cols="35" id="notes14" onKeyPress="javascript: checkValuenotes14();"><? if($cancel){ ?><? $notes14="";}?><? echo "$notes14"; ?></textarea>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($q1=="" or $q2==""  or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="" or $q12=="" or $q13=="" or $q14=="" or $q15=="" or $q16=="" or $q17=="")
		{
		...
		$add2="update table_kalibrasi_galeri set 
		notes1 = '$s_notes1',
		notes2 = '$s_notes2',
		notes3 = '$s_notes3',
		notes4 = '$s_notes4',
