...
<head>
<title>Kalibrasi Telesales</title>
...
<?
$q_user="select * from table_kalibrasi_telesales a inner join table_qm_telesales_detail b on a.id_qm=b.id_qm where a.id_qm='$id_qm'";
					//echo"$q_user";
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if( $q1=="" or $q2=="" or $q3=="" or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="" or $q12=="" or $q13=="" or $q14=="" or $q15=="" or $q16=="" or $q17=="" or $q18=="" or $q19=="" or $q20=="" )
		{
		...
		save_q19='$save_q19',
		save_q20='$save_q20',
		tot_score='$save_total' where id='$id'";
		  mssql_query($add2);
		  //echo "$q_addTemp";
