...
<body>
  ...
  <table width="386" border="1" align="center" class="table table-bordered table-infinite">
    ...
    <tr>
      ...
      <td><span class="content">
        <input name="date_prev_call" id="datepicker2" <? if ($repeat=="no"){?> disabled <? } else {}?> type="text" id="date_prev_call" value="<? echo "$date_prev_call"; ?>" datepicker="true" datepicker_format="MM/DD/YYYY"  class="input-large" tabindex="2">
      </span></td>
    </tr>
    <tr>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		$q="select id_qm from table_qm_detail where id_qm ='$id_qm'";
		$qq=mssql_query($q);
	 ...
	 if ($cancel)
		...
		?>
          <script type="text/javascript">
		window.location="add_inbound_detail.php"
		</script> 
          <?php
		}
