...
<body>
  ...
  <table width="386" border="1" align="center" class="table table-bordered table-infinite">
    ...
    <tr>
      ...
      <td><span class="content">
        <input name="date_prev_call" id="datepicker1" <? if ($repeat=="no"){?> disabled <? } else {}?> type="text"  value="<? echo "$date_prev_call"; ?>" datepicker="true" datepicker_format="MM/DD/YYYY"  class="input-large" tabindex="2">
      </span></td>
    </tr>
	<tr>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		* nama ketika diupload, jika $sameName > 0 maka pakai format "namafile($sameName).ext */
		...
		$q_addTemp="insert into table_qm_email_detail(recommendation,activity_code,id_qm,tenure,spv_name,interaction_date,observation_date,week_,customer_name,interaction_type,product_type,product_detail,product_detail_agent,repeat,date_prev_call,prev_agent,notes_recording,action_done_qa,action_done_ops,file_action_done_qa,file_action_done_ops,msisdn)
		  values('$s_recommendation','$activity_code','$id_qm','$tenure','$spv_name','$interaction_date_save',getdate(),'$week_','$customer_name','$interaction_type','$product_type','$product_detail','$product_detail_agent','$repeat','$date_prev_call','$prev_agent','$s_notes_recording','$s_action_done_qa','$s_action_done_ops','$newName','$newName2','$msisdn')";
