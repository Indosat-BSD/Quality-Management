...
include "konek_qm.php";
			...
			mssql_query($add);
				...
				echo"<script type='text/javascript'>
window.location='page.php?index=add_vip&div=cco'
</script> ";	
}
...
elseif($kode_del=="add_instagram")
{
include "konek_qm.php";
			$add="delete from table_qm_instagram where id_qm='$id_qm'";
			mssql_query($add);
			
echo"<script type='text/javascript'>
window.location='page.php?index=add_instagram&div=cco'
</script> ";		
}
...
include "konek_qm.php";
			...
			$add2="delete from table_qm_instagram_detail where id_qm='$id_qm'";
			mssql_query($add2);
			
echo"<script type='text/javascript'>
window.location='page.php?index=$st_del&report_by=$report_by&kd_division=$kd_division&kd_departemen=$kd_departemen&kd_unit=$kd_unit&date_eva1=$date_eva1&date_eva2=$date_eva2&kd_del=ok&c_observer=$c_observer&st_rep=$st_rep&select_region=$select_region&nik_agent=$nik_agent&cc_mentari=$cc_mentari'
</script> ";		
}
...
///Tambahan 16 Februari 2017 - Nisa ///
elseif($kode_del=="add_voce")
{
include "konek_qm.php";
			$add="delete from table_qm_voce where id_qm='$id_qm'";
			mssql_query($add);
			
echo"<script type='text/javascript'>
window.location='page.php?index=add_voce&div=cco'
</script> ";		
}
...
include "konek_qm.php";
			...
			$add2="delete from table_qm_voce_detail where id_qm='$id_qm'";
			mssql_query($add2);
			
echo"<script type='text/javascript'>
window.location='page.php?index=report_voce&report_by=$report_by&kode_del=detail_voce&id_qm=$id_qm&kd_division=$kd_division&kd_departemen=$kd_departemen&kd_unit=$kd_unit&date_eva1=$date_eva1&date_eva2=$date_eva2&c_observer=$observer'
</script> ";		
}
?>
