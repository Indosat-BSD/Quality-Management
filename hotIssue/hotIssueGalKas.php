...
<table id="dyntable2" class="table table-bordered table-infinite">
			...
			from table_qm_galeri_kasir a
			inner join table_qm_galeri_kasir_detail b on b.id_qm=a.id_qm 
