...
header("Content-Disposition: attachment; filename=hot_issue.xls"); 
...
<table border="1">
			...
			$qry_a		= mssql_query($sql_a);
				...
				while ($data_a	= mssql_fetch_array($qry_a))
						...
						$rubah = str_replace(",",", ",$product_type);//menambahkan tanda koma dengan spasi
