...
<form action="<? $PHP_SELF; ?>" method="POST" name="welcome" id="welcome">
  ...
  <table width="313" border="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>
	  <input name="searchButton" type="submit" id="searchButton" value="Search"  class="btn btn-primary"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <thead>
    ...
    <?
		...
		$stot="select count(*)as jum_s from db_qm.dbo.table_qm_instagram where status_save='not_complete' and id_pribadi_observer='$SES_hendi'";
//echo "$q1_yes_jum";
		  ...
		  if ($searchButton)
	  {
		...
		if($jum_tot1<>"0")
			...
			
			{
                 ...
                 echo"                      
                      <td><a href='?index=add_instagram&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi'>Create</a>
					  ";
							// }else{ echo "<td></td>";}
					  echo "</td></tr>";
					  $no++;
				...
				echo "<tr class='content'>
                      ...
                      <td><a href='?index=add_instagram&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi&nu=$nu'>Create</a>";
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
		...
		{
		$status=0;
		if($pol=="y" and ($userTextBox=="" or $namaTextBox=="" or $kd_division=="0" or $kd_departemen=="0" or $kd_unit=="0" or $sc1=="" or $sc2=="" or $sc3=="" or $sc4=="" or $sc5=="" or $sc6=="" or $sc7==""))
			{
			?>
            <script type="text/javascript">
			$status=1;
		...
		$q_addTemp="insert into table_qm_instagram(notes1,notes2,notes3,notes4,notes5,notes6,notes7,q1,q2,q3,q4,q5,q6,q7,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb, privacypol)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$s_notes6','$s_notes7','$sc1','$sc2','$sc3','$sc4','$sc5','$sc6','$sc7','$tot1','$tot2','$tot3','$tot4','$tot5','$tot6','$tot7','not_complete','$pribadi','$SES_hendi','$date_saved','$save_total','$kd_unit','$id_lb','$pol')";
		  mssql_query($q_addTemp);
		  //echo "$q_addTemp";
		  
		  
 echo"<script type='text/javascript'>
		window.location='?index=add_instagram&div=cco'
		</script> ";
	  	}
	  }
  ...
  <thead>
    ...
    <?
					$q_user="[sp_User_NotComplete]'table_qm_instagram','$SES_hendi'";
					//echo "$q_user";
					$r_user=mssql_query($q_user);
					$no2=1;
					while($d_user=mssql_fetch_array($r_user))
					...
					while($d_user1=mssql_fetch_array($r_user1))
					  ...
					  ?>
					  <a href="<? echo "add_instagram_detail.php?observer_name=$observer_name&id_qm=$id_qm&full_name=$full_name&observer=$observer&total_score=$score_tot&skala=$skala"; ?>" onClick="return popup(this, 'notes')">
					  <?
...
echo "<td>";
					  ...
					  <a href="<? echo "del_group.php?kode_del=add_instagram&id_qm=$id_qm"; ?>" onclick="return confirmDelete2();">
					  <?
					  	 echo "delete</a></td>	";			  
						echo "<td>";
					...
					$observname=$qqq["observer_name"];
					  ...
					  <a href="<? echo "edit_instagram_2.php?kode_edit=edit_instagram&id_qm=$id_qm&full_name=$full_name&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&sc1=$q1&sc2=$q2&sc3=$q3&sc4=$q4&sc5=$q5&sc6=$q6&sc7=$q7&userid=$userid&observer=$SES__NIK&date_saved=$date_saved&total_score=$score_tot&skala=$skala"; ?>" onClick="return popup(this, 'notes');" >	
