...
if (typeof(mylink) == 'string')
   ...
   href=mylink.href;
window.open(href, windowname, 'width=950,height=700,scrollbars=yes');
return false;
}
...
<form action="<? $PHP_SELF; ?>" method="post" name="welcome" id="welcome">
  ...
  <thead>
    ...
    <?
	$stot="select count(*)as jum_s from db_qm.dbo.table_qm_email where status_save='not_complete' and id_pribadi_observer='$SES_hendi'";
//echo "$q1_yes_jum";
		  ...
		  if ($searchButton)
	  {
		...
		if($jum_tot1<>"0")
			...
			
			{
                 ...
                 echo"                               
                      <td><a href='?index=add_email&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi'>Create</a>";
							// }else{ echo "<td></td>";}
					  echo "</td>
                      </tr>";
					  $no++;
				...
				echo "<tr class='content'>
                      ...
                      <td><a href='?index=add_email&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi&nu=$nu'>Create</a>";
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
		  ...
		  if ($Submit)
	  {
		...
		$status=0;
		if($pol=="y" and ($userTextBox=="" or $namaTextBox=="" or $kd_division=="0" or $kd_departemen=="0" or $kd_unit=="0" or $sc1=="" or $sc2==""  or $sc3=="" or $sc4=="" or $sc5=="" or $sc6=="" or $sc7=="" or $sc8=="" or $sc9=="" or $sc10==""))
			{
			?>
            <script type="text/javascript">
			$status=1;
		...
		$q_addTemp="insert into table_qm_email(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb,flag_status,privacypol)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$s_notes6','$s_notes7','$s_notes8','$s_notes9','$s_notes10','$sc1','$sc2','$sc3','$sc4','$sc5','$sc6','$sc7','$sc8','$sc9','$sc10','$tot1','$tot2','$tot3','$tot4','$tot5','$tot6','$tot7','$tot8','$tot9','$tot10','not_complete','$pribadi','$SES_hendi','$date_saved','$save_total','$kd_unit','$id_lb','4','$pol')";
		  mssql_query($q_addTemp);
		  //echo "$q_addTemp";
		  
 echo"<script type='text/javascript'>
		window.location='?index=add_email&div=cco'
		</script> ";
	  	}
	  }
  ...
  <thead>
    ...
    <?
					...
					/*$q_user="select a.*,b.nama,b.nik_karyawan,case when a.lb !='' then a.lb else b.nama end as lb from db_qm.dbo.table_qm_email a
inner join cco.hrms.dbo.tb_data_pribadi b on a.id_pribadi_user=b.id_data_pribadi where id_pribadi_observer='$SES_hendi' and status_save='not_complete'";*/
					$q_user="[sp_User_NotComplete]'table_qm_email','$SES_hendi'";
					//echo "$q_user";
					$r_user=mssql_query($q_user);
					$no2=1;
					while($d_user=mssql_fetch_array($r_user))
					...
					while($d_user1=mssql_fetch_array($r_user1))
					  ...
					  ?>
					  <a href="<? echo "add_email_detail.php?observer_name=$observer_name&id_qm=$id_qm&full_name=$full_name&observer=$observer&sc_fe=$sc_fe&sc_nfe=$sc_nfe&total_score=$score_tot&skala=$skala"; ?>" onClick="return popup(this, 'notes')">
					  <?
