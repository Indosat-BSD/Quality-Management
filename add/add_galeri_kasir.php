...
<form action="<? $PHP_SELF; ?>" method="post" name="welcome" id="welcome" onKeyPress="return noenter()">
  ...
  <thead>
    ...
    <?
	$stot="select count(*)as jum_s from db_qm.dbo.table_qm_galeri_kasir where status_save='not_complete' and id_pribadi_observer='$SES_hendi'";
//echo "$stot";
		...
		if($jum_tot1<>"0")
			...
			
			{
					...
					while($d_user=mssql_fetch_array($r_user))
                     ...
                     // if($akd_divisi == 'GAL'){
                echo"                          
                      <td><a href='?index=add_galeri_kasir&div=gal&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi'>Create</a>";
							// }else{ echo "<td></td>";}
					  echo "</td>
                      </tr>";
					  $no++;
				...
				echo "<tr class='content'>
                      ...
                      <td><a href='?index=add_galeri_kasir&div=gal&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi&nu=$nu'>Create</a>";
...
$result = mssql_query( $query );
  ...
  <thead>
    <tr bgcolor="#CCCCCC">
      <th width="17" classs="head0"><div align="center">No</div></th>
      <th width="36" classs="head0"><div align="center">Value</div></th>
      <th width="232" classs="head0"><div align="center">Attributes</div></th>
      <th width="71" classs="head0"><div align="center">Score</div></th>
      <th width="176"  classs="head0" bgcolor="#CCCCCC"><div align="center">Y/N/Na</div></th>
      <th width="363"  classs="head0" bgcolor="#CCCCCC"><div align="center">Notes</div></th>
    </tr>
	</thead>
    <tr>
      <td>1</td>
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
		  ...
		  if ($Submit)
	  {
		...
		if($userTextBox=="" or $namaTextBox=="" or $kd_division=="0" or $kd_departemen=="0" or $kd_unit=="0" or $q1=="" or $q2==""  or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="")
			{
			?>
            <script type="text/javascript">
		...
		$q_addTemp="insert into table_qm_galeri_kasir(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$s_notes6','$s_notes7','$s_notes8','$s_notes9','$s_notes10','$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$q9','$q10','$save_q1','$save_q2','$save_q3','$save_q4','$save_q5','$save_q6','$save_q7','$save_q8','$save_q9','$save_q10','not_complete','$pribadi','$SES_hendi',getdate(),'$save_total','$kd_unit','$id_lb')";
		  mssql_query($q_addTemp);
		  //echo "$q_addTemp";
		  
 echo"<script type='text/javascript'>
		window.location='?index=add_galeri_kasir&div=gal'
		</script> ";
	  	}
	  }
  ...
  <thead>
    ...
    <?
			/*$q_user="select a.*,b.nama,b.nik_karyawan,case when a.lb !='' then a.lb else b.nama end as lb from db_qm.dbo.table_qm_galeri_kasir a
inner join cco.hrms.dbo.tb_data_pribadi b on a.id_pribadi_user=b.id_data_pribadi where id_pribadi_observer='$SES_hendi' and status_save='not_complete'";*/
					$q_user="[sp_User_NotComplete]'table_qm_galeri_kasir','$SES_hendi'";
					//echo "$q_user";
					$r_user=mssql_query($q_user);
					$no2=1;
					while($d_user=mssql_fetch_array($r_user))
...
$sc_nfe=$sc_q1+$sc_q2+$sc_q6+$sc_q7+$sc_q8+$sc_q9+$sc_q10;
					...
					while($d_user1=mssql_fetch_array($r_user1))
					  ...
					  ?>
					  <a href="<? echo "add_galeri_kasir_detail.php?observer_name=$observer_name&id_qm=$id_qm&full_name=$full_name&observer=$observer&sc_fe=$sc_fe&sc_nfe=$sc_nfe&total_score=$total_score&skala=$skala"; ?>" onClick="return popup(this, 'notes')">
					  <?
