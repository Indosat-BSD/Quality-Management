			...
			
			{
				 ...
				 // }else{ echo "<td></td>";}
					echo"<td style='text-align:center;'><a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1&channel=Inbound'>Inbound</a>
						...
						<a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1&channel=VOCE'>VOCE</a>
						&nbsp&nbsp| &nbsp
						<a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1&channel=FMC'>FMC</a>";
					...
					echo "<tr class='content'>
						  ...
						  <td style='text-align:center;'><a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1&nu=$nu&channel=Inbound'>Inbound</a>
						    &nbsp&nbsp| &nbsp
						      <a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1&nu=$nu&channel=VOCE'>VOCE</a>";
    ...
    <tr>
		  ...
		  if ($Submit)
	  {
		...
		//echo "$q_addTemp";
  		...
  		echo"<script type='text/javascript'>
			  window.location='?index=add_inbound&div=cco'
		     </script> ";
	  	}
	  }
	...
	<?
		...
		echo "<tr class='content'>
                <td>$no2</td>";
					...
					?>
					  <a href="<? echo "add_inbound_detail.php?observer_name=$observer_name&id_qm=$id_qm&full_name=$full_name&observer=$observer&total_score=$score_tot"; ?>" onClick="return popup(this, 'notes')">
					<?
