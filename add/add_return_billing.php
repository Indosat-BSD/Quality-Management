...
<form action="<? $PHP_SELF; ?>" method="post" name="welcome" id="welcome">
  ...
  <thead>
    ...
    <?
	$stot="select count(*)as jum_s from db_qm.dbo.table_qm_rb where status_save='not_complete' and id_pribadi_observer='$SES_hendi'";//echo "$q1_yes_jum";
		...
		if($jum_tot1<>"0")
			...
			
			{
					...
					while($d_user=mssql_fetch_array($r_user))
                     ...
                     // if($akd_unit == 'CCC02B'){
                echo"                       
                      <td><a href='?index=add_return_billing&div=ccc&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi'>Create</a>";
							// }else{ echo "<td></td>";}
					  echo "</td>
                      </tr>";
					  $no++;
				...
				echo "<tr class='content'>
                      ...
                      <td><a href='?index=add_return_billing&div=ccc&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi&nu=$nu'>Create</a>";
...
$result = mssql_query( $query );
  ...
  <thead>
    ...
    <tr>
      ...
      <td><input name="sc1" type="radio"  value="7.5" <? if ($sc1=="7.5") {echo "checked";} else {echo "";} ?> />
      7.5 
        <input name="sc1" type="radio"  value="0.0" <? if ($sc1=="0.0") {echo "checked";} else {echo "";} ?> />
      0
  ...
  0
    ...
    <tr>
	  ...
	  <td><div style="background-color:#E0E0D1">
      Input Accuracy Data & Verification Address Customer</td>
...
1</td>
	...
	<tr>
	<td>4</td>
	  <td>Process Compliance/Privacy Policy</div></td>
  ...
  0
    ...
    <tr>
	  ...
	  <?   if($save_total >=100){$scrr=round($save_total,0);}else{$scrr=round($save_total,2);}echo"$scrr";  ?>
      </div></td>
    </tr>
  </table>
  <table width="948" border="0">
    <tr>
		  ...
		  if ($Submit)
	  {
		...
		if($userTextBox=="" or $namaTextBox=="" or $kd_division=="0" or $kd_departemen=="0" or $kd_unit=="0" or $sc1=="" or $sc2=="" or $sc3=="" or $sc4=="" or $sc5=="" or $sc6=="" or $sc7=="" or $sc8=="")
			{
			?>
            <script type="text/javascript">
		...
		$q_addTemp="insert into table_qm_rb(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,q1,q2,q3,q4,q5,q6,q7,q8,q9,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$s_notes6','$s_notes7','$s_notes8','$sc1','$sc2','$sc3','$sc4','$sc5','$sc6','$sc7','$sc8','0','$tot1','$tot2','$tot3','$tot4','$tot5','$tot6','$tot7','$tot8','0','not_complete','$pribadi','$SES_hendi',getdate(),'$save_total','$kd_unit','$id_lb')";
		  mssql_query($q_addTemp);
		  //echo "$q_addTemp";
		  
 echo"<script type='text/javascript'>
		window.location='?index=add_return_billing&div=ccc'
		</script> ";
	  	}
	  }
  ...
  <thead>
	...
	<tr bgcolor="#CCCCCC">
      ...
      <th colspan="3" class="head0"><div align="center">Input Accurary Data & Verification Address Customer</div></th>
...
inner join cco.hrms.dbo.tb_data_pribadi b on a.id_pribadi_user=b.id_data_pribadi where id_pribadi_observer='$SES_hendi' and status_save='not_complete'";*/
					$q_user="[sp_User_NotComplete]'table_qm_rb','$SES_hendi'";
					//echo "$q_user";
					$r_user=mssql_query($q_user);
					$no2=1;
					while($d_user=mssql_fetch_array($r_user))
					...
					while($d_user1=mssql_fetch_array($r_user1))
					  ...
					  ?>
					  <a href="<? echo "add_return_billing_detail.php?observer_name=$observer_name&id_qm=$id_qm&full_name=$full_name&observer=$observer&total_score=$score_tot"; ?>" onClick="return popup(this, 'notes')">
					  <?
...
echo "<td>";
					  ...
					  <a href="<? echo "del_group.php?kode_del=add_return_billing&id_qm=$id_qm"; ?>" onclick="return confirmDelete2();">
					  <?
					  	 echo "delete</a></td>	<td>";
						 ?>			  
					  <a href="<? echo "edit_return_billing.php?kode_edit=edit_inbound&report_by=$report_by&date_eva1=$date_eva1&date_eva2=$date_eva2&id_qm=$id_qm&full_name=$full_name&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&repeat=$repeat&date_prev_call=$date_prev_call2&prev_agent=$prev_agent&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&sc1=$q1&sc2=$q2&sc3=$q3&sc4=$q4&sc5=$q5&sc6=$q6&sc7=$q7&sc8=$q8&userid=$userid&observer=$SES__NIK&date_saved=$date_saved&total_score=$score_tot"; ?>" onClick="return popup(this, 'notes');">
					  <?
					  	 echo "Edit</a></td>
