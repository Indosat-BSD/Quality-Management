...
<?
		  ...
		  if ($Submit)
	  {
		...
		$q="select id_qm_detail from table_qm_hua_detail where id_qm_detail ='$id_qm'";
		$qq=mssql_query($q);
		...
		* nama ketika diupload, jika $sameName > 0 maka pakai format "namafile($sameName).ext */
		...
		$q_addTemp="insert into table_qm_hua_detail(action_done_qa,action_done_ops,file_action_done_qa,file_action_done_ops,id_qm,spv_name,interaction_date,observation_date,week_,customer_name,interaction_type,product_type,product_detail,product_detail_agent,call_activity,hh_handling_time,mm_handling_time,ss_handling_time,call_status,notes_recording)
		  ...
		  echo "$q_addTemp";
			   if ($simpan_data)
				{ 
				$q_addTemp2="update table_qm_hua set status_save='complete',date_saved='$observation_date' where id_qm='$id_qm'";
				echo "$q_addTemp2";
