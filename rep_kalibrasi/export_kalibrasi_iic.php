...
<table width="368%" border="1" align="center" cellspacing="1">
	...
	<td width="2%" rowspan="3" class="head0"><div align="center">Validation Date</div></td>
      ...
      <th colspan="6" class="header"><div align="center">Opening</div></th>
      <th colspan="12" class="header"><div align="center">Solution</div></th>
      <th colspan="6" class="header"><div align="center">Closing</div></th>
      <th colspan="6" class="header"><div align="center">Teknis berbicara / Effective Communication</div></th>
      <th colspan="3" class="header"><div align="center">Teknis Telephony</div></th>
	...
	<tr bgcolor="#CCCCCC">
	<th width="4%" colspan="3" class="header"><div align="center">Greeting with enthusiasm</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Verify (refer to verification rules)<div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Probing</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Correct Solution</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Input Accuracy Data / Information</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">FCR</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Reconfirm the Agreement</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Closing Greeting</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Kesopanan / Hospitality</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Personalize Communication</div></th>
	<th width="4%" colspan="3" class="header"><div align="center">Hold/Mute/Transfer</div></th>
	</tr>	
    <tr bgcolor="#CCCCCC">
      <th width="1%" class="header"><div align="center">Scale</div></th>
      <th width="5%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
      <th width="1%" class="header"><div align="center">Scale</div></th>
      <th width="5%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
      <th width="2%" class="header"><div align="center">Scale</div></th>
      <th width="3%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
      <th width="3%" class="header"><div align="center">Scale</div></th>
      <th width="3%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
      <th width="5%" class="header"><div align="center">Scale</div></th>
      <th width="5%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
      <th width="4%" class="header"><div align="center">Scale</div></th>
      <th width="4%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
      <th width="4%" class="header"><div align="center">Scale</div></th>
      <th width="4%" class="header"><div align="center">score</div></th>
      <th width="3%" class="header">Notes</th>
	...
	include "../konek_qm.php";
	 ...
	 $itung="[sp_count_kalibrasi]'table_kalibrasi_iic','table_qm_iic','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
...
//echo "$q1_yes_jum";
	...
	if(($jum_tot<>"0") or ($kd_del=="ok"and $jum_tot<>"0"))
					...
					$q_user="[sp_search_kalibrasi]'table_kalibrasi_iic','table_qm_iic','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo"$q_user";
...
//if ($repeat=="yes")
  ...
  <table width="408" border="1">
    ...
    <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm2]'table_kalibrasi_iic','table_qm_iic','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region'";
  ...
  <table width="264" border="1">
    ...
    <tr>
      ...
      <td><?  
			...
			$stot_hh="[sp_handling_kalibrasi]'table_kalibrasi_iic','table_qm_iic','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo $stot_hh;
    ...
    <tr>
      <td>Drop Call (Y) </td>
      <td><? 
		$stot_d="[sp_dropcall_kalibrasi]'table_kalibrasi_iic','table_qm_iic','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
