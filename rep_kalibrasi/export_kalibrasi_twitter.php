...
<p>&nbsp;</p>
  ...
  <thead>
	...
	<tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm_kalibrasi_email]'table_kalibrasi_twitter','table_qm_twitter','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$kd_unit%','%%','$select_region','$st_rep'";
	  		...
	  		if ($report_by=="Unit")
				  	{				  
					   ...
					   $stot_r="select count(*) as jum_s_r from db_qm.dbo.table_qm_twitter_detail c
					   			...
					   			where a.status_save='complete' and repeat='yes' and a.id_unit like '%$kd_unit%'
