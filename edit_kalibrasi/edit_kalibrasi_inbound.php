...
<head>
<title>Form Edit Validasi Inbound</title>
...
<? 
$query = "SELECT * FROM table_kalibrasi WHERE id='{$id}'";
...
<?
		  ...
		  if ($Submit)
	  {
		...
		$interaction_date_save="$interaction_date $hh$slas_e$mm$slas_e$ss2_e"; 
		 ...
		 $add="update table_qm set kalibrasi = '$agree' where id_qm='$id_qm'";
		  mssql_query($add);
		   
		$add2="update table_kalibrasi set 
		notes1 = '$s_notes1',
		notes2 = '$s_notes2',
		notes3 = '$s_notes3',
		notes4 = '$s_notes4',
