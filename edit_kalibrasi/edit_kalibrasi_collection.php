...
<head>
<title>Form Edit Validasi Collection</title>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($q3=="" or $q1=="" or $q2==""  or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="")
		{
		...
		$add="update table_qm_collection set kalibrasi = '$agree' where id_qm='$id_qm'";
		  mssql_query($add);
		
		  
		$add2="update table_kalibrasi_collection set 
		notes1 = '$s_notes1',
		notes2 = '$s_notes2',
		notes3 = '$s_notes3',
		notes4 = '$s_notes4',
