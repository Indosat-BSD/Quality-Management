...
<head>
<title>Validasi Galeri Kasir</title>
...
$q_user="select * from table_kalibrasi_galeri_kasir a inner join table_qm_galeri_kasir_detail b on a.id_qm=b.id_qm where a.id_qm='$id_qm'";
...
<?
		  ...
		  if ($Submit)
	  {
		...
		$add2="update table_kalibrasi_galeri_kasir set 
		notes1 = '$s_notes1',
		notes2 = '$s_notes2',
		notes3 = '$ns_otes3',
		notes4 = '$s_notes4',
