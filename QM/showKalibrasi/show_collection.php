...
<head>
<title>Validasi Collection</title>
...
$q_user="select * from table_kalibrasi_collection a inner join table_qm_collection_detail b on a.id_qm=b.id_qm where a.id_qm='$id_qm'";
...
<thead>
    <tr bgcolor="#CCCCCC" >
      ...
      <td><input name="q1" type="radio"  value="yes" <? if ($q1=="yes") {echo "checked";} else {echo "";} ?> disabled="disabled"disabled="disabled" />
  Yes
    <input name="q1" type="radio"  value="no" <? if ($q1=="no") {echo "checked";} else {echo "";} ?> disabled="disabled"disabled="disabled" />
  No
  <input name="q1" type="radio"  value="na" <? if ($q1=="na") {echo "checked";} else {echo "";} ?>disabled="disabled" disabled="disabled" />
  NA</td>
      <td><textarea disabled="disabled"   name="notes1" cols="35" id="notes1" disabled="disabled" onKeyPress="javascript: checkValuenotes1();"><? if($cancel){ ?><? $notes1="";}?><? echo "$notes1"; ?></textarea>
      <input name="jml_notes1" type="text" disabled="disabled"  id="jml_notes1" style="border-style:none; width:50px; background-color: white" value="0" disabled="disabled" /></td>
    </tr>
    <tr>
      <td>2</td>
      <td>NFE</td>
      ...
      <td><input name="q2" type="radio" disabled="disabled" value="yes" <? if ($q2=="yes") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  Yes
    <input name="q2" type="radio" disabled="disabled" value="no" <? if ($q2=="no") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  No
  <input name="q2" type="radio" disabled="disabled" value="na" <? if ($q2=="na") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  NA</td>
      <td><textarea disabled="disabled"  name="notes2" cols="35" id="notes2" onKeyPress="javascript: checkValuenotes2();"><? if($cancel){ ?><? $notes2="";}?><? echo "$notes2"; ?></textarea>
        <input name="jml_notes2" disabled="disabled" type="text" "disabled" id="jml_notes2" style="border-style:none; width:50px; background-color: white" value="0" disabled="disabled" /></td>
    </tr>
    <tr>
      <td>3</td>
      <td>FE</td>
...
15      </div></td>
  ...
  NA</td>
      <td><textarea disabled="disabled"  name="notes6" cols="35" id="notes6" onKeyPress="javascript: checkValuenotes6();"><? if($cancel){ ?><? $notes6="";}?><? echo "$notes6"; ?></textarea>
  ...
  NA</td>
      <td><textarea disabled="disabled"  name="notes13" cols="35" id="notes13" onKeyPress="javascript: checkValuenotes13();"><? if($cancel){ ?><? $notes13="";}?><? echo "$notes13"; ?></textarea>
  ...
  NA</td>
      <td><textarea disabled="disabled"  name="notes14" cols="35" id="notes14" onKeyPress="javascript: checkValuenotes14();"><? if($cancel){ ?><? $notes4="";}?><? echo "$notes14"; ?></textarea>
    ...
    <tr>
      ...
      <td>Hold</td>
      <td><div align="center">2.5</div></td>
      <td><input name="q15" type="radio"  value="yes" <? if ($q15=="yes") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  Yes
    <input name="q15" type="radio"  value="no" <? if ($q15=="no") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  No
  <input name="q15" type="radio"  value="na" <? if ($q15=="na") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  NA</td>
      <td><textarea disabled="disabled"  name="notes15" cols="35" id="notes15" onKeyPress="javascript: checkValuenotes15();"><? if($cancel){ ?><? $notes15="";}?><? echo "$notes15"; ?></textarea>
        <input name="jml_notes15" type="text" "disabled" id="jml_notes15" style="border-style:none; width:50px; background-color: white" value="0" disabled="disabled" /></td>
    </tr>
    <tr>
      <td>16</td>
      <td>NFE</td>
      ...
      <td><div align="center">7.5</div></td>
      <td><input name="q16" type="radio"  value="yes" <? if ($q16=="yes") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  Yes
    <input name="q16" type="radio"  value="no" <? if ($q16=="no") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  No
  <input name="q16" type="radio"  value="na" <? if ($q16=="na") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  NA</td>
      <td><textarea disabled="disabled"  name="notes16" cols="35" id="notes16" onKeyPress="javascript: checkValuenotes16();"><? if($cancel){ ?><? $notes16="";}?><? echo "$notes16"; ?></textarea>
        <input name="jml_notes16" type="text" "disabled" id="jml_notes16" style="border-style:none; width:50px; background-color: white" value="0" disabled="disabled" /></td>
    </tr>
    <tr>
      <td>17</td>
      <td>NFE</td>
      ...
      <td><div align="center">2.5</div></td>
      <td><input name="q17" type="radio"  value="yes" <? if ($q17=="yes") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  Yes
    <input name="q17" type="radio"  value="no" <? if ($q17=="no") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  No
  <input name="q17" type="radio"  value="na" <? if ($q17=="na") {echo "checked";} else {echo "";} ?> disabled="disabled" />
  NA</td>
      <td><textarea disabled="disabled"  name="notes17" cols="35" id="notes17" onKeyPress="javascript: checkValuenotes17();"><? if($cancel){ ?><? $notes17="";}?><? echo "$notes17"; ?></textarea>
        <input name="jml_notes17" type="text" "disabled" id="jml_notes17" style="border-style:none; width:50px; background-color: white" value="0" disabled="disabled" /></td>
    </tr>
    <tr>
      <td colspan="6">
	  ...
	  <?
		...
		if ($q3=="no" or $q4=="no" or $q5=="no" or $q6=="no" or $q20=="no")
		{
		$save_q3="0";
		$save_q4="0";
		$save_q5="0";
	  ...
	  ?>	  <div align="center">
	   <input name="cek_score" type="submit" id="cek_score" value="Cek Score"  class="btn"  disabled="disabled"/>
		...
		<br />
		NOTES : <br />
		<textarea name="notes_score"  disabled="disabled" cols="35" rows="10"  id="notes_score" disabled="disabled"><? echo "$notes_score";?></textarea><br />
		<input name="agree" type="radio"  disabled="disabled" value="Sesuai" <? if ($agree=="Sesuai") {echo "checked";} else {echo "";} ?> />SESUAI
   		<input name="agree" type="radio"  disabled="disabled" value="Tidak Sesuai" <? if ($agree=="Tidak Sesuai") {echo "checked";} else {echo "";} ?> />TIDAK SESUAI
		 <br /><br />
</div></td>
    </tr>
  </table>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($q3=="" or $q1=="" or $q2==""  or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="" or $q12=="" or $q13=="" or $q14=="" or $q15=="" or $q16=="" or $q17=="")
		{
