...
$q_user="select * from table_kalibrasi_sli a inner join table_qm_sli_detail b on a.id_qm=b.id_qm where a.id_qm='$id_qm'";
...
<thead>
  ...
  NA</td>
    ...
    <tr>
      <td>4</td>
      <td>FE</td>
      <td>Data Confirmation and Destination Number</td>
      <td><div align="center">10</div></td>
  ...
  NA</td>
    ...
    <tr>
      <td>5</td>
      <td>FE</td>
      <td>Collect Call Facility Approval</td>
  ...
  NA</td>
    ...
    NA</td>
      <td><textarea  disabled="disabled"  name="notes20" cols="35" id="notes20" onKeyPress="javascript: checkValuenotes20();"><? if($cancel){ ?><? $notes20="";}?><? echo "$notes20"; ?></textarea>
          <input name="jml_notes20" type="text" "disabled" id="jml_notes20" style="border-style:none; width:50px; background-color: white" value="0"  disabled="disabled" /></td>
    </tr>
    <tr>
      <td>7</td>
      <td>NFE</td>
  ...
  NA</td>
    ...
    <tr>
      <td>9</td>
      <td>NFE</td>
      <td>Hold/Routing/Call Ethique</td>
      <td><div align="center">5</div></td>
  ...
  NA</td>
    ...
    <tr>
      <td>10</td>
      <td>NFE</td>
      <td>ListeningConfirm to Connect</td>
      <td><div align="center">5</div></td>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($q20=="" or $q1=="" or $q2==""  or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="" or $q12=="")
		{
		...
		$add2="update table_kalibrasi_sli set 
		notes1 = '$s_notes1',
		notes2 = '$s_notes2',
		notes3 = '$s_notes3',
		notes4 = '$s_notes4',
