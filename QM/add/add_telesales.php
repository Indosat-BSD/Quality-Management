		...
		if($jum_tot1<>"0")
			...
			
			{
					...
					$q_user="select a.id_karyawan,a.nama,a.nik_karyawan,a.id_data_pribadi,left(z.id_unit,len(z.id_unit)-1) as id_fungsi,left(z.id_unit,charindex('0',z.id_unit)-1) as id_divisi,z.id_unit,b.nama_unit,c.qm
							...
							full join cco.hrms.dbo.tb_unit b on a.id_unit=b.id_unit
							inner join cco.hrms.dbo.tb_auth c on a.id_data_pribadi=c.id_data_pribadi
							where status_kerja=1 and (a.nik_karyawan like '%$userText%' or a.id_karyawan like '%$userText%') and a.nama like '%$namaText%' and a.id_unit like '%CCO05%'";
...
$result = mssql_query( $query );
  ...
  <p>&nbsp;</p>
	...
	<tr>
	<td colspan="2"><h1>Detail Penilaian</h1></td>
	</tr>
	<tr>
	<td>Team Leader</td>
	<td><input name="tl" type="text" id="tl" value="<? echo "$tl"; ?>" /></td>
	</tr>	
	<tr>
	<td>Tanggal Transaksi</td>
	<td><input name="date_eva1" type="text" id="datepicker" value="<? echo "$date_eva1"; ?>" datepicker="true" datepicker_format="MM/DD/YYYY" class="box" tabindex="2" /></td>
	</tr>	
	<tr>
	<td>MSISDN</td>
	<td><input name="msisdn" type="text" id="msisdn" value="<? echo "$msisdn"; ?>" maxlength="13" onChange="phonenumber(document.welcome.msisdn)" />
			<script type="text/javascript">
  ...
  <table width="948" border="0">
    <tr>
		  ...
		  if ($Submit)
	  {
		...
		if($userTextBox=="" or $namaTextBox=="" or $kd_division=="0" or $kd_departemen=="0" or $kd_unit=="0" or $sc1=="" or $sc2=="" or $sc3=="" or $sc4=="" or $sc5=="" or $sc6=="" or $sc7=="" or $sc8=="" or $sc9=="" or $sc10=="" or $sc11=="" or $sc12=="" or empty($tl) or empty($date_eva1) or empty($msisdn) )
			{
			?>
            <script type="text/javascript">
		...
		$q_addTemp="insert into table_qm_telesalesnew(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,notes11,notes12,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,save_q11,save_q12,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,team_leader,tanggal_transaksi,msisdn)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$s_notes6','$s_notes7','$s_notes8','$s_notes9','$s_notes10','$s_notes11','$s_notes12','$sc1','$sc2','$sc3','$sc4','$sc5','$sc6','$sc7','$sc8','$sc9','$sc10','$sc11','$sc12','$tot1','$tot2','$tot3','$tot4','$tot5','$tot6','$tot7','$tot8','$tot9','$tot10','$tot11','$tot12','$pribadi','$SES_hendi',getdate(),'$save_total','$kd_unit','".$_POST['tl']."','".$_POST['date_eva1']."','".$_POST['msisdn']."')";
