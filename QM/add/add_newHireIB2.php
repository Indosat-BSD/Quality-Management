...
<form action="<? $PHP_SELF; ?>" method="post" name="welcome" id="welcome" onKeyPress="return noenter()">
  ...
  <thead>
    <tr bgcolor="#CCCCCC">
	  ...
	  <th width="100" class="head0"><div align="center">Absolute Scale</div></th>
...
echo "<td>";
					  ...
					  <a href="<? echo "del_group2.php?kode_del=add_newHireIB&id_qm=$id_qm"; ?>" onclick="return confirmDelete2();">
					  <?
					  echo "delete</a></td><td>";
					  ?>
