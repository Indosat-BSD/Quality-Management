...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($ss="" or $spv_name=="" or $interaction_date=="" or $observation_date=="" or $week_=="0" or $customer_name=="" or $interaction_type=="0" or $product_type=="" or $product_detail=="" or $product_detail_agent==""  or  hh_2=="" or $mm_2=="" or $notes_recording=="")
			{
			?>
            <script type="text/javascript">
		...
		$q_addTemp="insert into table_qm_galeri_kasir_detail(id_qm,spv_name,interaction_date,observation_date,week_,customer_name,interaction_type,product_type,product_detail,product_detail_agent,hh_handling_time,mm_handling_time,ss_handling_time,notes_recording)
		  values('$id_qm','$s_spv_name','$interaction_date_save',getdate(),'$week_','$s_customer_name','$interaction_type','$s_product_type','$s_product_detail','$s_product_detail_agent','$hh_2','$mm_2','$ss_2','$s_notes_recording')";
		  $simpan_data=mssql_query($q_addTemp);
		//echo "$q_addTemp";
		  if ($simpan_data)
					 { 
		$q_addTemp2="update table_qm_galeri_kasir set status_save='complete' where id_qm='$id_qm'";
	 ...
	 if ($cancel)
		...
		?>
          <script type="text/javascript">
		window.location="add_galeri_kasir_detail.php"
		</script> 
          <?php
		}
