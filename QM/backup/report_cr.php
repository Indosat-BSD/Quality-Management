...
$sc_nfe=$sc_q1+$sc_q2+$sc_q3+$sc_q7+$sc_q8+$sc_q9+$sc_q10+$sc_q11+$sc_q12+$sc_q13+$sc_q14+$sc_q15+$sc_q16+$sc_q17+$sc_q18+$sc_q19;
  ...
  <thead>
    ...
    <tr>
      ...
      //edit hendi
      $queryhendi="[sp_reportqm_colection]'table_qm_cr','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','$cc_mentari','$cc_im3','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
  ...
  <table border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      ...
      <td><?  
		...
		$stot_fe="[sp_fetotal_colection]'table_qm_cr','$report_by','$tgl1','$tgl2','$kd_unit','$cc_mentari','$cc_im3','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
		//echo "$stot_fe";
