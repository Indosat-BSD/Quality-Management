...
NA</td>
  ...
  NA</td>
      ...
      <td><div align="center">15</div></td>
      <td><input name="q20" type="radio"  value="yes" <? if ($q7=="yes") {echo "checked";} else {echo "";} ?> />
      Yes
        <input name="q20" type="radio"  value="no" <? if ($q7=="no") {echo "checked";} else {echo "";} ?> />
      No
      <input name="q20" type="radio"  value="na" <? if ($q7=="na") {echo "checked";} else {echo "";} ?> />
NA</td>
      <td><textarea name="notes20" cols="35" id="notes20" onkeypress="javascript: checkValuenotes20();"><? if($cancel){ ?><? $notes7="";}?><? echo "$notes7"; ?></textarea>
          <input name="jml_notes20" type="text" "disabled" id="jml_notes20" style="border-style:none; width:50px; background-color: white" value="0" /></td>
    </tr>
    <tr>
