...
//echo "$stot";
	...
	if ($searchButton)
	  {
		...
		if($jum_tot1<>"0")
			...
			
			{
                 ...
                 echo"<td><a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1'>Create</a>"; 
				 }else{ echo "<td></td>";}
					...
					echo "<tr class='content'>
						  ...
						  <td><a href='?index=add_inbound&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$lb&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi1&nu=$nu'>Create</a>";
  ...
  <table width="313" border="0">
    <tr>
	 ...
	 if(isset($searchButton) and $jum_tot1=="0"){
	 	if($pribadi!=''){
		  $sql = mssql_query("select * from hrms.dbo.tb_data_pribadi where id_data_pribadi ='$pribadi'");
		//}else{
		  //$sql = mssql_query("select * from hrms.dbo.tb_data_pribadi where id_data_pribadi ='$pribadi'");
		//}
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
		  ...
		  if ($Submit)
	  {
		...
		if($userTextBox=="" or $namaTextBox=="" or $kd_division=="0" or $kd_departemen=="0" or $kd_unit=="0" or $q1=="" or $q2==""  or $q3=="" or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="" or $q12=="" or $q13=="" or $q14=="")
			{
			?>
            <script type="text/javascript">
		...
		$q_addTemp="insert into table_qm(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,notes11,notes12,notes13,notes14,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12,q13,q14,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,save_q11,save_q12,save_q13,save_q14,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb)
  ...
  <thead>
    ...
    <?
					$q_user="select a.*,b.nama,b.nik_karyawan, case when a.lb !='' then a.lb else b.nama end as lb from db_qm.dbo.table_qm a
...
$total_score = round($total_score,2);
					...
					while($d_user1=mssql_fetch_array($r_user1))
					  ...
					  ?>
					  <a href="<? echo "add_inbound_detail.php?observer_name=$observer_name&id_qm=$id_qm&full_name=$full_name&observer=$observer&sc_fe=$sc_fe&sc_nfe=$sc_nfe&total_score=$total_score&skala=$skala"; ?>" onClick="return popup(this, 'notes')">
					  <?
