...
printf("%1.2f ", $prosen_q14_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      ...
      <td><? 
			$stot_hh="[sp_handling_colection]'table_qm_email','$report_by','$date_eva1','$date_eva2','$kd_unit','$cc_mentari','$cc_im3','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
			//echo $stot_hh;
