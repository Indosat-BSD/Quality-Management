...
<? if ($st_rep =='1'){ //report tampil lama?>
    ...
    <?
	include "../konek_qm.php";
	  $itung="[sp_count_kalibrasi_cole]'table_kalibrasi_twitter','table_qm_twitter','$date_eva1','$date_eva2','$report_by','%$kd_unit%','$cc_mentari','$cc_im3','$obs','%$nik_agent%','$select_region','$st_rep'";
	 
	 $queryitung=mssql_query($itung);
	 $hasilitung=mssql_fetch_array($queryitung);
	 $jum_tot=$hasilitung["jum_s"];

					$q_user="[sp_search_kalibrasi_cole]'table_kalibrasi_twitter','table_qm_twitter','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
					//echo"$q_user";
...
//
  ...
  <table width="568" border="1">
    ...
    <tr>
	  ...
	  $queryhendi="[sp_reportqm_kalibrasi_cole]'table_kalibrasi_twitter','table_qm_twitter','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$kd_unit%','%%','$select_region','$st_rep'";			  //edit hendi
...
printf("%1.2f ", $prosen_q12_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      ...
      <td><?  
		...
		$stot_fe="[sp_fetotal_kalibrasi_cole]'table_kalibrasi_twitter','table_qm_twitter','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
		//echo $stot_fe;
 ...
 <? }else{ //data baru?>
      ...
      <th width="4%" rowspan="2" class="header"><div align="center">CE Accuracy </div></th>
      <th width="4%" rowspan="2" class="header"><div align="center">NCE Accuracy </div></th>
      <th width="4%" rowspan="2" class="header"><div align="center">Total Score </div></th>
      <th width="4%" rowspan="2" class="header"><div align="center">Skala</div></th>
	  <th width="4%" rowspan="2" class="header"><div align="center">Recommendation</div></th>
  ...
  <table width="568" border="1">
    ...
    <tr>
     <td>1</td>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm_kalibrasi_cole]'table_kalibrasi_twitter','table_qm_twitter','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$kd_unit%','%%','$select_region','$st_rep'";	
	  $proses=mssql_query($queryhendi);
	  $result=mssql_fetch_array($proses);
      //end edit
	  $q1_tot_y=$result["q1_yes"];
...
printf("%1.2f ", $prosen_q2_na);
    ...
    <tr>
      ...
      <td><?  
		...
		?></td>
      <td><?
$prosen_q4_y =($q3_tot_y/$jum_tot)*100 ;
