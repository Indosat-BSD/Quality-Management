...
<body>
  ...
  <table width="386" border="1" align="center" class="table table-bordered table-infinite">
    ...
    <tr>
      <td>Call Activity </td>
      <td><select name="call_activity" id="call_activity" class="uniformselect">
        <option value="0">Select
        <?php
			$katahh2=array('call respon','call update','call close');
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($recommendation=="" or $ss_2=="" or $spv_name=="" or $interaction_date=="" or $observation_date=="" or $week_=="0" or $customer_name=="" or $interaction_type=="0" or $product_type=="" or $product_detail=="" or $product_detail_agent=="" or $call_activity=="0" or hh_2=="" or $mm_2=="" or $call_status=="0" or $sr=="" or $notes_recording=="")
			{
			?>
            <script type="text/javascript">
		...
		$q_addTemp="insert into table_qm_cr_detail(recommendation,sr,id_qm,spv_name,interaction_date,observation_date,week_,customer_name,interaction_type,product_type,product_detail,product_detail_agent,call_activity,hh_handling_time,mm_handling_time,ss_handling_time,call_status,notes_recording)
		  values('$s_recommendation','$sr','$id_qm','$spv_name','$interaction_date_save',getdate(),'$week_','$customer_name','$interaction_type','$product_type','$product_detail','$product_detail_agent','$call_activity','$hh_2','$mm_2','$ss_2','$call_status','$s_notes_recording')";
