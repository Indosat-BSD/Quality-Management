...
function confirmDelete2()
{
  ...
  <thead>
    ...
    <tr>
      ...
      <td>
		<?  
			$queryhendi="[sp_reportqm_newhire]'table_qm_newHireIB','$tgl1','$tgl2','$report_by','$obs','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala','1'";  
		  //echo"$queryhendi";
  ...
  <?  
	  		if ($select_region !="") {
	  			if ($report_by=="Unit")
				  	{
			 		  $stot_fcr="[sp_fcr_tot_newhire]'table_qm_newHireIB','$report_by','$tgl1','$tgl2','%$kd_unit%','$select_region','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','%$skala%','%$departemen_skala%','%$unit_skala%'";
				 	  //echo"$stot_fcr";
	  			...
	  			if ($report_by=="Unit")
					  ...
					  where fcr='fcr' and a.status_save='complete' and a.id_unit like '%$kd_unit%' 
				 	  and  convert(varchar,a.date_saved,112) between '$tgl1' and '$tgl2'";*/
			 		  $stot_fcr="[sp_fcr_tot_newhire]'table_qm_newHireIB','$report_by','$tgl1','$tgl2','%$kd_unit%','$select_region','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','%$skala%','%$departemen_skala%','%$unit_skala%','1'";
					  //echo"$stot_fcr";
					  /*$stot_rep="select count(*) as jum_s_rep from db_qm.dbo.table_qm_newHireIB_detail c
					   inner join db_qm.dbo.table_qm_newHireIB a on a.id_qm=c.id_qm 
					   inner join hrms.dbo.tb_data_pribadi b on a.id_pribadi_user=b.id_data_pribadi
...
";   */
	...
	<tr>
      ...
      <td width="68">
		<?  $q6_tot_n=$result["q6_no"];
			...
			//2-0 , 0,2,100
			//echo"$jum_tot-$rep_tot_y , $q6_tot_n,$jum_tot,100";
    ...
    <tr>
      ...
      <td width="68">
		<?  
			$stot_hh="[sp_handling_newhire]'table_qm_newHireIB','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','1'";
			//echo"$stot_hh";
