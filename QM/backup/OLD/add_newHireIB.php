...
<form action="<? $PHP_SELF; ?>" method="post" name="welcome" id="welcome" onKeyPress="return noenter()">
  ...
  <table width="313" border="0">
    <tr>
      ...
      <td>
	  <?php
							 echo "<a class='btn btn-leave' href='?index=add_newHireIB'>Karyawan</a>";
							 echo "<a class='btn btn-pilih' href='?index=add_newHireIB2'>Seleksi</a>";
	  ?>
	  </td>
    </tr>
    <tr>
		  ...
		  if ($searchButton)
	  {
		...
		if($jum_tot1<>"0")
			...
			
			{
                ...
                echo"                     
                      <td><a href='?index=add_newHireIB&div=cco&edit=t&userTextBox=$usernameS&namaTextBox=$full_name&id_lb=$lb&searchButton=1&kd_division=$akd_divisi&kd_departemen=$akd_departemen&userid=$userid&userText=$userText&namaText=$namaText&kd_unit=$akd_unit&useridHidden=$userid&nikTextBox=$nik&pribadi=$pribadi'>Create</a>";
						}else{ echo "<td></td>";}
					  echo "</td> </tr>";
					  $no++;
					}
    ...
    return confirm('Are you sure you wish to delete this entry?');
		  ...
		  if ($Submit)
	  {
		...
		$q_addTemp="insert into table_qm_newHireIB(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,notes11,notes12,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,save_q11,save_q12,save_q13,save_q14,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$s_notes6','$s_notes7','$s_notes8','$s_notes9','$s_notes10','$s_notes11','$s_notes12','$sc1','$sc2','$sc3','$sc4','$sc5','$sc6','$sc7','$sc8','$sc9','$sc10','$sc11','$sc12','$tot1','$tot2','$tot3','$tot4','$tot5','$tot6','$tot7','$tot8','$tot9','$tot10','$tot11','$tot12','0','0','not_complete','$pribadi','$SES_hendi',getdate(),'$save_total','$kd_unit','$id_lb')";
...
echo "<td>";
					  ...
					  <a href="<? echo "del_group.php?kode_del=add_newHireIB&id_qm=$id_qm"; ?>" onclick="return confirmDelete2();">
					  <?
					  echo "delete</a></td><td>";
					  ?>
