...
<table width="368%" border="1" align="center" cellspacing="1">
  <tr bgcolor="#CCCCCC">
    ...
    <td width="2%" rowspan="2" class="header"><div align="center">Validation Date </div></td>
    ...
    <td width="4%" rowspan="2" class="header"><div align="center">Validation</div></td>
  ...
  <?
	...
	$itung="[sp_count_kalibrasi]'table_kalibrasi','table_qm','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
...
<table width="568" border="1">
  ...
  <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm_kalibrasi]'table_kalibrasi','table_qm','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region'";
...
printf("%1.2f ", $prosen_q14_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      <td>CE Total </td>
      <td><?  
					$stot_fe="[sp_fetotal_kalibrasi]'table_kalibrasi','table_qm','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo $stot_fe;
    ...
    <tr>
      ...
      <td><?  
					$stot_hh="[sp_handling_kalibrasi]'table_kalibrasi','table_qm','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo $stot_hh;
    ...
    <tr>
      <td>Drop Call (Y) </td>
      <td><?  
	   $stot_d="[sp_dropcall_kalibrasi]'table_kalibrasi','table_qm','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
	   //echo $stot_d;
