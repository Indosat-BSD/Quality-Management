...
from db_qm.dbo.Table_qm_telesales a inner join
    ...
    <tr class="content">
     ...
     <tr class="content">
      ...
      <td><select name="departemen_skala" id="select" class="box" onchange="satu.submit()"  >
            <option value="" <?php if ($departemen_skala=='0') echo 'selected=true' ;?> >
           Selected </option> 
           <option value="CCO05" <?php if ($departemen_skala=='CCO05') echo 'selected=true' ;?> >
           Teleretention </option>   
...
$result11 = mssql_query( $query11 );
  ...
  <p>&nbsp;</p>
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
	 ...
	 $itung="[sp_count_telesales]'table_qm_telesales','$tgl1','$tgl2','$report_by','%$kd_unit%','%$cc_tele%','$obs','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
	 //echo $itung;
...
//echo "$q1_yes_jum";
  ...
  <thead>
	...
	<? if ($SES_KODE_LEVEL<>"mitra" and $SES_KODE_LEVEL<>"telesales" and $SES_KODE_LEVEL<>"cr" and $SES_KODE_LEVEL<>"inbound"){?>
		<? if ($st_rep =='2'){?>  
...
<? if ($st_rep =='1'){ //menampilkan data lama?>  
	...
	<?
					 $q_user="[sp_search_telesales]'table_qm_telesales','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
					//echo"$q_user";
...
?> 
					<td><a href="showKalibrasi/show_telesales.php?id=<? echo "$id";?>&id_qm=<? echo "$id_qm";?>&agree=<? echo "$agree";?>" onClick="return popup(this, 'notes');">	
					<? if ($id_kalibrasi != ""){
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryyanti="[sp_reportqm_telesales]'table_qm_telesales','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$cc_tele%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
...
printf("%1.2f ", $prosen_q19_na);
  ...
  <table width="264" border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
		$stot_fe="[sp_fetotal_telesales]'table_qm_telesales','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
					  ...
					  <a href="<? echo "del_group.php?report_by=$report_by&kode_del=detail_telesales&id_qm=$id_qm&kd_division=$kd_division&kd_departemen=$kd_departemen&kd_unit=$kd_unit&date_eva1=$date_eva1&date_eva2=$date_eva2&c_observer=$observer&st_rep=$st_rep"; ?>" onclick="return confirmDelete2();">
					  <?
					  	 echo "delete</a></td>";	
						  echo "<td>";
						   $q ="select nama as observer_name from hrms.dbo.tb_data_pribadi where id_data_pribadi='$observer'";
					...
					$observname=$qqq["observer_name"];
					  ...
					  <a href="<? echo "edit_telesales.php?kode_edit=edit_telesales&id_qm=$id_qm&full_name=$full_name&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&call_status=$call_status&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&call_activity=$call_activity&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&notes9=$notes9&notes10=$notes10&notes11=$notes11&notes12=$notes12&notes13=$notes13&q1=$q1&q2=$q2&q3=$q3&q4=$q4&q5=$q5&q6=$q6&q7=$q7&q8=$q8&q9=$q9&q10=$q10&q11=$q11&q12=$q12&q13=$q13&save_q1=$save_q1&save_q2=$save_q2&save_q3=$save_q3&save_q4=$save_q4&save_q5=$save_q5&save_q6=$save_q6&save_q7=$save_q7&save_q8=$save_q8&save_q9=$save_q9&save_q10=$save_q10&save_q11=$save_q11&save_q12=$save_q12&save_q13=$save_q13&userid=$userid&observer=$SES__NIK&date_saved=$date_saved&fe_acc=$sc_fe&nfe_acc=$sc_nfe&total_score=$total_score&skala=$skala&notes_recording=$notes_recording"; ?>" onClick="return popup(this, 'notes');">
					  <?
					  	 echo "Edit</a></td>";
						 }			  
		if ($q1=="yes" or $q1=="na")
...
<? }?>  
    <tr>
      ...
      <td><? 
			$stot_hh="[sp_handling_telesales]'table_qm_telesales','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
			//echo $stot_hh;
