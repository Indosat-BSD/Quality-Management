...
<?
		  ...
		  if ($Submit)
	  {
		...
		$q_addTemp="insert into Table_qm_credit_detail(id_qm,spv_name,interaction_date,observation_date,week_,customer_name,interaction_type,product_type,product_detail,product_detail_agent,call_activity,hh_handling_time,mm_handling_time,ss_handling_time,call_status,notes_recording)
		...
		$q_addTemp2="update table_qm_credit set status_save='complete',date_saved=getdate() where id_qm='$id_qm'";
