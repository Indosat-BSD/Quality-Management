...
from db_qm.dbo.Table_kalibrasi_galeri a inner join
...
$result2 	= mssql_query("SET ANSI_WARNINGS ON") or die(mssql_get_last_message());
	 ...
	 //edit hendi
	$itung="[sp_countGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$tgl1','$tgl2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$obs','%$nik_agent%'";
...
<table width="368%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
	...
	<?
					 $q_user="[sp_searchGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$report_by','%$kd_unit%','$tgl1','$tgl2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%'";
					//echo"$q_user";
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
					  ...
					  <a href="<? echo "del_kalibrasi.php?report_by=$report_by&kode_del=detail_galeri&id_qm=$id_qm&kd_division=$kd_division&kd_departemen=$kd_departemen&kd_unit=$kd_unit&date_eva1=$date_eva1&date_eva2=$date_eva2&c_observer=$observer&id=$id"; ?>" onclick="return confirmDelete2();">
					  <?
					  	 echo "delete</a></td>";
	}
						 echo "<td>";
...
//if ($repeat=="yes")
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqmGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','%$kd_unit%','%%'";
...
printf("%1.2f ", $prosen_q17_na);
  ...
  <table width="264" border="1"  class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><? 
		$stot_fe="[sp_fetotalgalery_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$report_by','$tgl1','$tgl2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%'";
	   //echo"$stot_fe";
    ...
    <tr>
      ...
      <td><?  
	  			if ($report_by=="Unit")
					 ...
					 $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c inner join db_qm.dbo.table_kalibrasi_galeri a
    ...
    <tr>
      ...
      <td><?  
			...
			$stot_hh="[sp_handlingGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$report_by','$tgl1','$tgl2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%'";
					//echo $stot_hh;
