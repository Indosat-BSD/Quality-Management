...
<table width="368%" border="1" align="center" cellspacing="1">
  ...
  <tr bgcolor="#CCCCCC">
	...
	include "../konek_qm.php";
	 ...
	 $itung="[sp_countGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%'";
...
//echo "$q1_yes_jum";
	...
	if(($jum_tot<>"0") or ($kd_del=="ok"and $jum_tot<>"0"))
					...
					$q_user="[sp_searchGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%'";
					//echo"$q_user";
...
//if ($repeat=="yes")
  ...
  <table width="568" border="1">
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqmGal_kalibrasi] 'table_kalibrasi_galeri','table_qm_galeri','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','%$kd_unit%','%%'";
...
printf("%1.2f ", $prosen_q17_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
		$stot_fe="[sp_fetotalgalery_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer',
		'%$nik_agent%'";
    ...
    <tr>
      ...
      <td><?  
	  			if ($report_by=="Unit")
					 ...
					 $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c inner join 
					 db_qm.dbo.table_kalibrasi_galeri a
	  			...
	  			if ($report_by=="Departement")
				  	{				  
				 	  ...
				 	  $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c 
				 	  inner join db_qm.dbo.table_kalibrasi_galeri a
	  			...
	  			if ($report_by=="Validator")
					  ...
					  $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c 
					  inner join db_qm.dbo.table_kalibrasi_galeri a
				 	  			on a.id_qm=c.id_qm inner join hrms.dbo.tb_data_pribadi z  
				 	  			on a.id_pribadi_observer=cast(id_data_pribadi as varchar)
	  			...
	  			if ($report_by=="Agent")
				  	{				  
				 	  ...
				 	  inner join db_qm.dbo.table_kalibrasi_galeri a
				 	  			on a.id_qm=c.id_qm inner join hrms.dbo.tb_data_pribadi z  
				 	  			on a.id_pribadi_user=cast(id_data_pribadi as varchar)
				 	  			where fcr='fcr' and a.status_save='complete' and  cast(id_data_pribadi as varchar)='$c_observer'
				 	  			and  convert(varchar,a.date_saved,112) between '$date_eva1' and '$date_eva2'";
	   				}
    ...
    <tr>
      ...
      <td><?  
			...
			$stot_hh="[sp_handlingGal_kalibrasi]'table_kalibrasi_galeri','table_qm_galeri','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%'";
					//echo $stot_hh;
