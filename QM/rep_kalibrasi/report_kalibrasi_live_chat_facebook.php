...
from db_qm.dbo.Table_kalibrasi_lcfb a inner join
...
$r_observerCombo = mssql_query( $q_observerCombo );
    ...
    <tr class="content">
      ...
      <td><input name="searchButton" type="submit" id="searchButton" value="Search"  class="btn btn-primary"/>
		  ...
		  echo "<a class='btn btn-warning' href='rep_kalibrasi/export_kalibrasi_live_chat_facebook.php?st_rep=$st_rep&cc_mentari=$cc_mentari&cc_im3=$cc_im3&cc_pp=$cc_pp&cc_matrix=$cc_matrix&cc_m2=$cc_m2&cc_ftm=$cc_ftm&report_by=$report_by&nik_agent=$nik_agent&c_observer=$c_observer&kd_unit=$kd_unit&date_eva1=$tgl1&date_eva2=$tgl2&select_region=$select_region'>export to excel</a>";
  ...
  <?
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
	 ...
	 $itung="[sp_count_kalibrasi_cole]'table_kalibrasi_lcfb','table_qm_lcfb','$tgl1','$tgl2','$report_by','%$kd_unit%','$cc_mentari','$cc_im3','$obs','%$nik_agent%','$select_region','$st_rep'";
...
<? if ($st_rep =='2'){ //report live chat?>
	...
	<?
		$q_user="[sp_search_kalibrasi_cole]'table_kalibrasi_lcfb','table_qm_lcfb','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
		//echo"$q_user";
...
function confirmDelete2()
{
    ...
    <?
					...
					$observname=$qqq["observer_name"];
					  ?>
    </a><a href="<? echo "edit_kalibrasi/edit_kalibrasi_live_chat_facebook.php?st_rep=$st_rep&kode_edit=edit_live_chat_facebook&id=$id&id_qm=$id_qm&full_name=$full_name&tenure=$tenure&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&fcr=$fcr&repeat=$repeat&date_prev_call=$date_prev_call2&prev_agent=$prev_agent&recommendation=$recommendation&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&drop_call=$drop_call&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&sc1=$q1&sc2=$q2&sc3=$q3&sc4=$q4&sc5=$q5&sc6=$q6&sc7=$q7&sc8=$q8&userid=$userid&observer=$SES__NIK&date_saved=$date_saved&fe_acc=$sc_fe&nfe_acc=$sc_nfe&total_score=$score_tot&skala=$skala2&notes_score=$notes_score&agree=$agree"; ?>" onclick="return popup(this, 'notes');">
    <?
					  	 echo "Edit</a></td>";
	}		  
  ...
  <thead>
	...
	<tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm_kalibrasi_email]'table_kalibrasi_lcfb','table_qm_lcfb','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$kd_unit%','%%','$select_region','$st_rep'";
	  //echo "$queryhendi";
	  		...
	  		if ($report_by=="Unit")
				  	{				  
					   ...
					   $stot_r="select count(*) as jum_s_r from db_qm.dbo.table_qm_lcfb_detail c
					   			inner join db_qm.dbo.table_kalibrasi_lcfb a on a.id_qm=c.id_qm
