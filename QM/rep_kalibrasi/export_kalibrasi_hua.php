...
<p>&nbsp;</p>
 <table width="368%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
	...
	$itung="[sp_count_kalibrasi_credit]'table_kalibrasi_hua','table_qm_hua','$date_eva1','$date_eva2','$report_by','%$kd_unit%','$cc_mentari','$cc_im3','%%','%%','%%','%%','%%','%%','%%','%%','$c_observer','%$nik_agent%','$select_region'";
...
//echo "$q1_yes_jum";
					...
					$q_user="[sp_search_kalibrasi_credit]'table_kalibrasi_hua','table_qm_hua','$report_by','%$kd_unit%','$date_eva1','$date_eva2','$cc_mentari','$cc_im3','%%','%%','%%','%%','%%','%%','%%','%%','$c_observer','%$nik_agent%','$select_region'";
					//echo $q_user;
					//echo "456456";
...
//if ($repeat=="yes")
  ...
  <table width="568" border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm_kalibrasi_email]'table_kalibrasi_hua','table_qm_hua','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','$cc_mentari','$cc_im3','%$kd_unit%','%%','$select_region',''";
  ...
  <table width="264" border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      ...
      <td>
		<?  
			$stot_hh="[sp_handling3]'table_qm_hua','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
