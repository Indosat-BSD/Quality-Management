...
$query = "SELECT *, convert(varchar,interaction_date,108) as jam, convert(varchar,observation_date,101) as observ, 
			...
			FROM table_qm_twitter_detail WHERE id_qm='{$id_qm}'";
$result = mssql_query( $query );
...
<?
 //nfe total
$nfe_total=$q1_tot_y+$q2_tot_y+$q3_tot_y+$q7_tot_y+$q8_tot_y+$q9_tot_y+$q1_tot_na+$q2_tot_na+$q3_tot_na+$q7_tot_na+$q8_tot_na+$q9_tot_na+$q10_tot_na+$q11_tot_na+$q12_tot_na;
