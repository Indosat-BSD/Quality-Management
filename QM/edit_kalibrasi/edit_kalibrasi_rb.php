...
<head>
<title>Form Edit Validasi Return Billing</title>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($sc1=="" or $sc2=="" or $sc3=="" or $sc4=="" or $sc5=="" or $sc6=="" or $sc7=="" or $sc8=="" or $sc9=="")
		{
		...
		$add="update table_qm_rb set kalibrasi = '$agree' where id_qm='$id_qm'";
		  mssql_query($add);
		
		  
		$add2="update table_kalibrasi_rb set 
		notes1 = '$s_notes1',
		notes2 = '$s_notes2',
		notes3 = '$s_notes3',
		notes4 = '$s_notes4',
