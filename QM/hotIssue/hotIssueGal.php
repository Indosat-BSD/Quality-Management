  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr class="content">
      <td><input name="searchButton" type="submit" id="searchButton" value="Search"  class="btn btn-primary"/></td>
		  ...
		  echo "<a class='btn btn-warning' href='hotIssue/hotIssueGalSim.php?cc_mentari=$cc_mentari&cc_im3=$cc_im3&cc_pp=$cc_pp&report_by=$report_by&nik_agent=$nik_agent&c_observer=$c_observer&kd_unit=$kd_unit&tgl1=$tgl1&tgl2=$tgl2&select_region=$select_region&pilih_bulan=$pilih_bulan&pilih_tahun=$pilih_tahun	'>export to excel</a>";
		  echo "<a class='btn btn-warning' href='hotIssue/hotIssueGalword.php?cc_mentari=$cc_mentari&cc_im3=$cc_im3&cc_pp=$cc_pp&report_by=$report_by&nik_agent=$nik_agent&c_observer=$c_observer&kd_unit=$kd_unit&tgl1=$tgl1&tgl2=$tgl2&select_region=$select_region&pilih_bulan=$pilih_bulan&pilih_tahun=$pilih_tahun	'>export to word</a>";
		  echo "<a class='btn btn-warning' href='hotIssue/hotIssueGalppt.php?cc_mentari=$cc_mentari&cc_im3=$cc_im3&cc_pp=$cc_pp&report_by=$report_by&nik_agent=$nik_agent&c_observer=$c_observer&kd_unit=$kd_unit&tgl1=$tgl1&tgl2=$tgl2&select_region=$select_region&pilih_bulan=$pilih_bulan&pilih_tahun=$pilih_tahun	'>export to ppt</a>";
		  ?></td>
		  </td>
		   <td>&nbsp;</td>
		    <td width="0%">&nbsp;</td>
...
<table id="dyntable2" class="table table-bordered table-infinite">
			...
			from table_qm_galeri a
			inner join table_qm_galeri_detail b on b.id_qm=a.id_qm 
