...
<table id="dyntable2" class="table table-bordered table-infinite">
			...
			from table_qm_email a
			inner join table_qm_email_detail b on b.id_qm=a.id_qm 
