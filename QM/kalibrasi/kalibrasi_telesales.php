...
$r_observerCombo = mssql_query( $q_observerCombo );
  ...
  <p>&nbsp;</p>
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
	 ...
	 $itung="[sp_countAdd_kalibrasi_cole]'table_qm_telesales','$tgl1','$tgl2','$report_by','%$kd_unit%','%$cc_tele%','','$c_observer','%$nik_agent%','$select_region','$st_rep'";
	 //echo $itung;
...
//echo "$q1_yes_jum";
  ...
  <thead>
	...
	<?
					//$q_user="[sp_searchAdd_kalibrasi]'table_qm_telesales','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_tele%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					$q_user="[sp_searchAdd_kalibrasi_cole]'table_qm_telesales','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_tele%','','$c_observer','%$nik_agent%','$select_region','$st_rep'";
					//echo"$q_user";
