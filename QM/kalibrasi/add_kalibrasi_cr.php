...
<?
		  ...
		  if ($Submit)
	  {
		...
		if ($n <= 0) {
			$add="insert into table_kalibrasi_cr(notes1,notes2,notes3,notes4,notes5,q1,q2,q3,q4,q5,save_q1,save_q2,save_q3,save_q4,save_q5,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb,id_qm,notes_score,id_kalibrasi,flag_status)
		  values('$s_notes1','$s_notes2','$s_notes3','$s_notes4','$s_notes5','$sc1','$sc2','$sc3','$sc4','$sc5','$tot1','$tot2','$tot3','$tot4','$tot5','complete','$id_pribadi_user','$observer',getdate(),'$save_total','$kd_unit','$id_lb','$id_qm','$notes_score','$SES_hendi','4')";
			mssql_query($add);
		// echo "$add";
