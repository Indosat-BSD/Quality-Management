...
$r_observerCombo = mssql_query( $q_observerCombo );
  ...
  <p>&nbsp;</p>
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
	 ...
	 $itung="[sp_countAdd_kalibrasi_cole]'table_qm_twitter','$tgl1','$tgl2','$report_by','%$kd_unit%','$cc_mentari','$cc_im3','$obs','%$nik_agent%','$select_region','$st_rep'";
...
<table width="70%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
	...
	<?
					$q_user="[sp_searchAdd_kalibrasi_cole]'table_qm_twitter','$report_by','%$kd_unit%','$tgl1','$tgl2','$cc_mentari','$cc_im3','$c_observer','%$nik_agent%','$select_region','$st_rep'";
