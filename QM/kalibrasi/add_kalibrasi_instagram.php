	...
	if ($Submit)
	  {
		...
		$c ="select * from table_kalibrasi_instagram where id_qm='$id_qm'";
		$q = mssql_query($c);
		$n = mssql_num_rows($q);
		
		if ($n <= 0) {
		$add="insert into table_kalibrasi_instagram(notes1,notes2,notes3,notes4,notes5,notes6,notes7,q1,q2,q3,q4,q5,q6,q7,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb,id_qm,notes_score,id_kalibrasi)
		...
		echo"$add";
		 ...
		 $add2="update table_qm_instagram set id_kalibrasi='$SES_hendi', kalibrasi='$agree' where id_qm='$id'";
		  mssql_query($add2);
		 // echo "$q_addTemp";
		}
