...
$r_observerCombo = mssql_query( $q_observerCombo );
  ...
  <p>&nbsp;</p>
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
	 ...
	 $itung="[sp_countAdd_kalibrasi]'table_qm_instagram','$tgl1','$tgl2','$report_by','%$kd_unit%','%$cc_mentari%','','','','','','','','','','%$c_observer%','%$nik_agent%','$select_region'";
...
//echo "$q1_yes_jum";
	...
	{	 ?>
<table id="dyntable" width="70%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
    <tr bgcolor="#CCCCCC">
      <th width="1%" class="head0"><div align="center">No</div></th>
      <th width="4%" class="head0"><div align="center">Username</div></th>
	  <th width="4%" class="head0"><div align="center">Region</div></th>
      <th width="2%" class="head0"><div align="center">Nama</div></th>
      <th width="2%" class="head0">Tenure</th>
      <th width="2%" class="head0"><div align="center">TL/SPV</div></th>
      <th width="2%" class="head0"><div align="center">Interaction Date </div></th>
      <th width="2%" class="head0"><div align="center">Observation Date</div></th>
      <th width="2%" class="head0"><div align="center">Week</div></th>
      <th width="2%" class="head0"><div align="center">Customer Name</div></th>
	  <th width="2%" class="head0"><div align="center">MSISDN</div></th>
      <th width="2%" class="head0"><div align="center">Notes Sample Recording </div></th>
      <th width="4%" class="head0"><div align="center">Total Score </div></th>
      <th width="4%" class="head0"><div align="center">Skala</div></th>
	  <th width="4%" class="head0"><div align="center">Recommendation</div></th>
      <th width="4%" class="head0"><div align="center">Observer</div></th>
	  <th width="4%" class="head0"><div align="center">Privacy Policy</div></th>
    </tr>
	</thead>	
	
	<?
					$q_user="[sp_searchAdd_kalibrasi]'table_qm_instagram','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_mentari%','','','','','','','','','','%$c_observer%','%$nik_agent%','$select_region'";
...
<tr>	
		<td>
			<a href="<? echo "kalibrasi/add_kalibrasi_instagram.php?id_qm=$id_qm&full_name=$full_name&tenure=$tenure&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&fcr=$fcr&repeat=$repeat&date_prev_call=$date_prev_call2&prev_agent=$prev_agent&recommendation=$recommendation&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&drop_call=$drop_call&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&sc1=$q1&sc2=$q2&sc3=$q3&sc4=$q4&sc5=$q5&sc6=$q6&sc7=$q7&userid=$userid&observer=$observer&date_saved=$date_saved&fe_acc=$sc_fe&nfe_acc=$sc_nfe&total_score=$score_tot&skala=$skala2&kd_unit=$kd_unit&id_pribadi_user=$id_pribadi_user"; ?>" onClick="return popup(this, 'notes');"><? echo $no;?></a>
		</td>
		<?		   
		echo"<td>$userid</td>
					  <td>$region</td>
