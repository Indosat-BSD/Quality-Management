...
<head>
<title>Form Kalibrasi VOCE</title>
...
<?	
	...
	if($Submit)
	  {
		if( $sc1=="" or $sc2==""  or $sc3=="" or $sc4=="" or $sc5=="" or $sc6=="" or $sc7=="" or $sc8=="" or $sc9=="" or $sc10==""  or $agree=="")
		{?>
		...
		$add="insert into table_kalibrasi_voce(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb,id_qm,notes_score,id_kalibrasi)
		values('$notes1','$notes2','$notes3','$notes4','$notes5','$notes6','$notes7','$notes8','$notes9','$notes10','$sc1','$sc2','$sc3','$sc4','$sc5','$sc6','$sc7','$sc8','$sc9','$sc10','$tot1','$tot2','$tot3','$tot4','$tot5','$tot6','$tot7','$tot8','$tot9','$tot10','complete','$id_pribadi_user','$observer','$date_saved','$save_total','$kd_unit','$id_lb','$id','$notes_score','$SES_hendi')";
			mssql_query($add);
		//echo "$add";
		  
		 $add2="update table_qm_voce set id_kalibrasi='$SES_hendi', kalibrasi='$agree' where id_qm='$id'";
		 mssql_query($add2);
		  //echo "$q_addTemp";
