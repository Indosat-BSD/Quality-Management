...
$result11 = mssql_query( $query11 );
  ...
  <p>&nbsp;</p>
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
	 ...
	 $itung="[sp_count3]'table_qm_telesales','$tgl1','$tgl2','$report_by','%$kd_unit%','%$cc_tele%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
	 //echo $itung;
...
//echo "$q1_yes_jum";
  ...
  <thead>
	...
	<?
					 $q_user="[sp_search3]'table_qm_telesales','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_tele%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
					//echo"$q_user";
...
?> 
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm3]'table_qm_telesales','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$cc_tele%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala'";
...
printf("%1.2f ", $prosen_q19_na);
  ...
  <table width="264" border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
		$stot_fe="[sp_fetotal2]'table_qm_telesales','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_tele%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
    ...
    <tr>
      ...
      <td><? 
			$stot_hh="[sp_handling3]'table_qm_telesales','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_tele%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
