...
<body>
	...
	<table width="290%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
		...
		<tr bgcolor="#CCCCCC">
		  <th colspan="2" class="head0"><div align="center">Activity</div></th>
	...
	<?
		$a_user="[new_report_email]'table_qm_cr','$report_by','$tgl1','$tgl2','$select_region','$st_rep','popup','$id_pribadi_user' ";
	...
	?>
		  ...
		  $tgl2 = date('Ymd',strtotime($tgl2));
			...
			echo "&nbsp&nbsp$nbsp<a class='btn btn-warning' href='export_cr_detail.php?id_pribadi_user=$id_pribadi_user&report_by=$report_by&kd_unit=$kd_unit&tgl1=$tgl1&tgl2=$tgl2&st_rep=$st_rep'>export to excel</a>";
