...
$result11 = mssql_query( $query11 );
    ...
    <tr class="content">
      ...
      <td><input name="searchButton" type="submit" id="searchButton" value="Search"  class="btn btn-primary"/>
		  ...
		  echo "<a class='btn btn-warning' href='report/export_credit.php?cc_mentari=$cc_mentari&cc_im3=$cc_im3&report_by=$report_by&nik_agent=$nik_agent&c_observer=$c_observer&kd_unit=$kd_unit&date_eva1=$tgl1&date_eva2=$tgl2&select_region=$select_regionn&skala=$skala_cmb&depart=$departemen_skala&unitSkala=$unit_skala&skalacmb=$skala_cmb'>export to excel</a>";
		  ?></td>
    </tr>
  </table>
  <p>&nbsp;</p>
  ...
  <thead>
    <tr bgcolor="#CCCCCC">
     ...
     <!-- nilai NFE-->
        ...
        <th colspan="3" class="head0"><div align="center">Permission and purpose to call</div></th>
		<!-- nilai FE-->
        ...
        <th colspan="3" class="head0"><div align="center">Approval Verification Prosess</div></th>
		<!-- nilai NFE-->
        <th colspan="3" class="head0"><div align="center">Greating Customer Name</div></th>
	...
	$itung="[sp_count3]'table_qm_credit','$tgl1','$tgl2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$obs','%$nik_agent%','$select_region','$skalacmb','$departemen_skala','$unit_skala'";
...
//echo "$q1_yes_jum";
	...
	if((isset($searchButton) and $jum_tot<>"0") or ($kd_del=="ok"and $jum_tot<>"0"))
					...
					$q_user="[sp_search3]'table_qm_credit','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skalacmb','$departemen_skala','$unit_skala'";
					//echo $q_user;
					//echo "456456";
...
?>
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm3]'table_qm_credit','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala'";
...
printf("%1.2f ", $prosen_q11_na);
  ...
  <table width="264" border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
					$stot_fe="[sp_fetotal_credit]'table_qm_credit','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
					//echo $stot_fe;
    ...
    <tr>
      ...
      <td><?  
					$stot_hh="[sp_handling3]'table_qm_credit','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
					//echo $stot_hh;
