  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr class="content">
      ...
      <td><select name="select_channel">
			...
			<option value="Vip" <?=($select_channel=='Vip')?'Selected':'';?>>VIP</option>
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
					  ...
					  ?>
    <a href="<? echo "del_group.php?report_by=$report_by&kode_del=detail_vip&id_qm=$id_qm&kd_division=$kd_division&kd_departemen=$kd_departemen&kd_unit=$kd_unit&date_eva1=$date_eva1&date_eva2=$date_eva2&c_observer=$observer"; ?>" onclick="return confirmDelete2();">
    <?
					  	 echo "delete</a></td>";
    ...
    <?
			...
			<td><a href="showKalibrasi/show_vip.php?id=<? echo "$id";?>&id_qm=<? echo "$id_qm";?>&agree=<? echo "$agree";?>" onClick="return popup(this, 'notes');">	
			<? if ($id_kalibrasi != ""){
  ...
  <thead>
    ...
    <tr>
      ...
      <td>
		<?  
		  $queryhendi="[sp_reportqm_vip2]'table_qm','$tgl1','$tgl2','$report_by','%$c_observer%','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala','','$select_channel'";
...
<h4 class="widgettitle">Chart VIP</h4>
