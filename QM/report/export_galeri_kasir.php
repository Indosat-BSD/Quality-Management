...
<table width="368%" border="1" align="center" cellspacing="1">
  ...
  <?
	include "../konek_qm.php";
	 ...
	 $itung="[sp_count3]'table_qm_galeri_kasir','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','','$skala','$departemen_skala','$unit_skala'";
	 $queryitung=mssql_query($itung);
	 $hasilitung=mssql_fetch_array($queryitung);
	 $jum_tot=$hasilitung["jum_s"];

					$q_user="[sp_search3]'table_qm_galeri_kasir','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','','$skala','$departemen_skala','$unit_skala'";
					//echo"$q_user";
...
<p>Total data : <? echo"$jum_tot"; ?></p>
  <table width="568" border="1">
    ...
    <tr>
      ...
      <td><?  
				 //edit hendi
      $queryhendi="[sp_reportqm11]'table_qm_galeri_kasir','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','%$kd_unit%','%%','$skala','$departemen_skala','$unit_skala'";
  ...
  <table width="264" border="1">
    ...
    <tr>
      ...
      <td><?  
		...
		/* $stot_fe="[sp_fetotalgalery11]'table_qm_galeri_kasir','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
		*/
		$stot_fe="[sp_fetotalgalery11]'table_qm_galeri_kasir','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
    ...
    <tr>
      ...
      <td><?  
			$stot_hh="[sp_handling11]'table_qm_galeri_kasir','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
					//echo $stot_hh;
