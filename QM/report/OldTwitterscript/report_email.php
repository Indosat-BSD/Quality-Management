...
<? }else if($st_rep=='3'){?>    
<table border="1" align="center" cellspacing="1" id="dyntable" class="table table-bordered table-infinite">
    <tr bgcolor="#CCCCCC">
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
					...
					$observname=$qqq["observer_name"];
					  ...
					  <a href="<? echo "edit_email.php?st_rep=$st_rep&kode_edit=edit_email&activity_code=$activity_code&id_qm=$id_qm&tenure=$tenure&full_name=$full_name&call_activity=$call_activity&call_status=$call_status&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&fcr=$fcr&repeat=$repeat&date_prev_call=$date_prev_call&prev_agent=$prev_agent&recommendation=$recommendation&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&drop_call=$drop_call&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&notes9=$notes9&notes10=$notes10&sc1=$q1&sc2=$q2&sc3=$q3&sc4=$q4&sc5=$q5&sc6=$q6&sc7=$q7&sc8=$q8&userid=$userid&observer=$SES__NIK&date_saved=$date_saved&fe_acc=$sc_fe&nfe_acc=$sc_nfe&total_score=$score_tot&skala=$skala2&notes_recording=$notes_recording"; ?>" onClick="return popup(this, 'notes');">	
...
?>
  ...
  <thead>
    ...
    <tr>
	  ...
	  <td><div style="background-color:#E0E0D1">Greeting user account name, Care and Friendly</div></td>
      <td>10</td>
	  <td colspan="4"></td>
      <td><?  
				  //edit hendi
...
between '$tgl1' and '$tgl2' and a.flag_status=3 and a.id_unit like '%$departemen_skala%' and a.id_unit like '%$unit_skala%' AND a.id_qm in( select id_qm from 
