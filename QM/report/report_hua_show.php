...
<body>
	...
	<?
		$a_user="[new_report_CC]'table_qm_hua','$report_by','$tgl1','$tgl2','$select_region','popup','$id_pribadi_user' ";
	...
	?>
		  ...
		  $tgl2 = date('Ymd',strtotime($tgl2));
			...
			echo "&nbsp&nbsp$nbsp<a class='btn btn-warning' href='export_hua_detail.php?id_pribadi_user=$id_pribadi_user&report_by=$report_by&kd_unit=$kd_unit&tgl1=$tgl1&tgl2=$tgl2&st_rep=$st_rep'>export to excel</a>";
