...
<table width="368%" border="1" align="center" cellspacing="1">
  ...
  <?
	...
	$itung="[sp_count3]'table_qm_newHireIB','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$obs','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
...
//echo "$q1_yes_jum";
					...
					$q_user="[sp_search3]'table_qm_newHireIB','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$c_observer%','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
					//echo"$q_user";
...
<table width="568" border="1">
  <tr bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm_inbound]'table_qm_newHireIB','$date_eva1','$date_eva2','$report_by','%$c_observer%','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$depart','$unitSkala',''";
  ...
  <?   
	  		if ($select_region !="") {
	  			if ($report_by=="Unit")
					  ...
					  $stot_fcr="[sp_fcr_tot]'table_qm_newHireIB','$report_by','$date_eva1','$date_eva2','%$kd_unit%','$select_region','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','%$skala%','%$departemen_skala%','%$unit_skala%'";
					 ...
					 /* $stot_rep="select count(*) as jum_s_rep from db_qm.dbo.table_qm_newHireIB_detail c
					   ...
					   $stot_rep="[sp_repeat_tot]'table_qm_newHireIB','$report_by','$date_eva1','$date_eva2','%$kd_unit%','$select_region','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','%$skala%','%$departemen_skala%','%$unit_skala%'";
	   				}
...
where a.status_save='complete' and b.fcr='fcr' and convert(varchar,a.date_saved,112) between '$date_eva1' and '$date_eva2' and a.id_unit like '%$depart%' and a.id_unit like '%&unitSkala%' AND
a.id_qm in(
select id_qm from (
					select a.id_qm,
					...
					where a.status_save='complete' and b.fcr='fcr' and convert(varchar,a.date_saved,112)
					 between '$date_eva1' and '$date_eva2' and a.id_unit like '%$depart%' and a.id_unit like '%&unitSkala%' 
				    group by a.id_qm 
				) AA
...
between '$date_eva1' and '$date_eva2' and a.id_unit like '%$depart%' and a.id_unit like '%&unitSkala%' AND a.id_qm in( select id_qm from 
...
";   */
    ...
    <tr>
      ...
      <td width="68">
		<?   
				$stot_hh="[sp_handling3]'table_qm_newHireIB','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
					//echo $stot_hh;
