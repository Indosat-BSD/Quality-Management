...
<p>&nbsp;</p>
 <table width="368%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
	...
	$itung="[sp_count2]'table_qm_collection','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
...
//echo "$q1_yes_jum";
					...
					$q_user="[sp_search2]'table_qm_collection','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo $q_user;
					//echo "456456";
...
//if ($repeat=="yes")
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm2]'table_qm_collection','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region'";
...
printf("%1.2f ", $prosen_q17_na);
  ...
  <table width="264" border="1" class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
					$stot_fe="[sp_fetotalcollection]'table_qm_collection','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo $stot_fe;
    ...
    <tr>
      ...
      <td><?  
					$stot_hh="[sp_handling2]'table_qm_collection','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region'";
					//echo $stot_hh;
