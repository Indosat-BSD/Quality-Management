...
<script type="text/javascript">
    ...
    Highcharts.chart('containerdc', {
        ...
        title: {
            text: 'REPORT CORRES TWITTER'
        },
        subtitle: {
            text: 'Periode <?=$date_eva1;?> Until <?=$date_eva2;?>'
        },
        xAxis: {
            categories: [
	...
	<table width="290%" border="1" align="center" cellspacing="1" class="table table-bordered table-infinite">
		...
		<tr bgcolor="#CCCCCC">
		  ...
		  <th width="4%" rowspan="2" colspan="2" class="head0"><div align="center">Total</div></th>
	...
	if($tipe_report=='summary'){
		...
		$a_user="[sp_search_colection]'table_qm_twitter','$report_by','%$kd_unit%','$tgl1','$tgl2','$cc_mentari','$cc_im3','$c_observer','%$nik_agent%','$select_region','$skalacmb','$departemen_skala','$unit_skala','$st_rep','summary' ";
		...
		while($c_user=mssql_fetch_array($b_user)){
			echo "<tr class='content'>
				<td>".(string)$c_user['nik_karyawan']."</td>
				<td>".(string)$c_user['full_name']."</td>
				<td>".(string)$c_user['q1_yes']."</td>
				<td>".(string)$c_user['q1_no']."</td>
				<td>".(string)$c_user['q2_yes']."</td>
				<td>".(string)$c_user['q2_no']."</td>
				<td>".(string)$c_user['q3_yes']."</td>
				<td>".(string)$c_user['q3_no']."</td>
				<td>".(string)$c_user['q4_yes']."</td>
				<td>".(string)$c_user['q4_no']."</td>
				<td>".(string)$c_user['q5_yes']."</td>
				<td>".(string)$c_user['q5_no']."</td>
				<td>".(string)$c_user['q6_yes']."</td>
				<td>".(string)$c_user['q6_no']."</td>
				<td>".(string)$c_user['q7_yes']."</td>
				<td>".(string)$c_user['q7_no']."</td>
				<td>".(string)$c_user['q8_yes']."</td>
				<td>".(string)$c_user['q8_no']."</td>
				<td>".(string)$c_user['q9_yes']."</td>
				<td>".(string)$c_user['q9_no']."</td>
				<td>".(string)$c_user['q10_yes']."</td>
				<td>".(string)$c_user['q10_no']."</td>
				<td>".(string)$c_user['q11_yes']."</td>
				<td>".(string)$c_user['q11_no']."</td>
				<td>".(string)$c_user['tot_yes']."</td>
				<td>".(string)$c_user['tot_no']."</td>."?>
