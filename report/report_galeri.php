    ...
    <tr class="content">
     ...
     <tr class="content">
      ...
      <td><select name="departemen_skala" id="select" class="box" onchange="satu.submit()"  >
           ...
           <option value="GAL" <?php if ($departemen_skala=='GAL') echo 'selected=true' ;?> >All </option>   
		  
		   <option value="GAL00" <?php if ($departemen_skala=='GAL00') echo 'selected=true' ;?> >BaliNusRa Area </option>   
		    <option value="GAL01" <?php if ($departemen_skala=='GAL01') echo 'selected=true' ;?> >Jateng Area </option>   
		     <option value="GAL02" <?php if ($departemen_skala=='GAL02') echo 'selected=true' ;?>>Jakarta Area </option>   
		 <option value="GAL03" <?php if ($departemen_skala=='GAL03') echo 'selected=true' ;?>>Botabek Area </option>   <option value="GAL04" <?php if ($departemen_skala=='GAL04') echo 'selected=true' ;?>>NSRO Area </option>   <option value="GAL05" <?php if ($departemen_skala=='GAL05') echo 'selected=true' ;?>>SulamPapua Area</option>   <option value="GAL06" <?php if ($departemen_skala=='GAL06') echo 'selected=true' ;?>>Kalimantan Area </option>   <option value="GAL07" <?php if ($departemen_skala=='GAL07') echo 'selected=true' ;?>>Jabar Area </option>   <option value="GAL08" <?php if ($departemen_skala=='GAL08') echo 'selected=true' ;?>>Jatim Area </option>   <option value="GAL09" <?php if ($departemen_skala=='GAL09') echo 'selected=true' ;?>>SSRO Area </option>      
      </select></td>
      </tr>
...
$result11 = mssql_query( $query11 );
    ...
    <tr class="content">
      ...
      <?
		  ...
		  echo "<a class='btn btn-warning' href='report/export_galeri.php?bali=$bali&jateng=$jateng&jakarta=$jakarta&botabek=$botabek&nsro=$nsro&sulam=$sulam&kalimantan=$kalimantan&jabar=$jabar&jatim=$jatim&ssro=$ssro&report_by=$report_by&nik_agent=$nik_agent&c_observer=$c_observer&kd_unit=$kd_unit&date_eva1=$tgl1&date_eva2=$tgl2&select_region=$select_region&skala=$skala&depart=$departemen_skala&unitSkala=$unit_skala'>export_galeri to excel</a>";
		  ?></td>
    </tr>
  </table>
  <p>&nbsp;</p>
...
$result2 	= mssql_query("SET ANSI_WARNINGS ON") or die(mssql_get_last_message());
	 ...
	 //edit hendi
	$itung="[sp_count3]'table_qm_galeri','$tgl1','$tgl2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$obs','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
...
<table width="368%" border="1" id="dyntable" align="center" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
    <tr bgcolor="#CCCCCC">
      ...
      <th colspan="3" class="head0"><div align="center">Data Gathering</div></th>
      ...
      <th colspan="3" class="head0"><div align="center">Human Touch</div></th>
      ...
      <th colspan="3" class="head0"><div align="center">Empowerment</div></th>
	...
	<?
					 $q_user="[sp_search3]'table_qm_galeri','$report_by','%$kd_unit%','$tgl1','$tgl2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','','$skala','$departemen_skala','$unit_skala'";
					//echo"$q_user";
...
//if ($repeat=="yes")
			...
			$s_prev_agent="-";
					...
					<td><a href="showKalibrasi/show_galeri.php?id=<? echo "$id";?>&id_qm=<? echo "$id_qm";?>&agree=<? echo "$agree";?>" onClick="return popup(this, 'notes');">
					<? if ($id_kalibrasi != ""){
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm11]'table_qm_galeri','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','%$kd_unit%','%%','$skala','$departemen_skala','$unit_skala'";
...
printf("%1.2f ", $prosen_q17_na);
  ...
  <table width="264" border="1"  class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><? 
		$stot_fe="[sp_fetotalgalery11]'table_qm_galeri','$report_by','$tgl1','$tgl2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
	   //echo"$stot_fe";
    ...
    <tr>
      ...
      <td><?  
	  			if ($report_by=="Unit")
				  	{				  
				 	 //$stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c,db_qm.dbo.table_qm_galeri a,assest_galeri.dbo.table_usr b  where a.status_save='complete'  and a.id_qm=c.id_qm and fcr='fcr' and a.userid=b.username and a.kd_unit like '%$kd_unit%' and a.date_saved between '$date_eva1 00:00:00.000' and '$date_eva2 23:59:59.000'";
					 $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c inner join db_qm.dbo.table_qm_galeri a
	  			...
	  			if ($report_by=="Departement")
				  	{				  
				 	 //$stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c,db_qm.dbo.table_qm_galeri a,assest_galeri.dbo.table_usr b  where a.status_save='complete'  and a.id_qm=c.id_qm and fcr='fcr' and a.userid=b.username and (a.kd_unit like '%$cc_mentari%') and a.date_saved between '$tgl1 00:00:00.000' and '$tgl2 23:59:59.000'";
				 	  $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c inner join db_qm.dbo.table_qm_galeri a
				 	  			on a.id_qm=c.id_qm where fcr='fcr' and a.status_save='complete' and (a.id_unit like '%$bali%' or a.id_unit like '%$jateng%' or a.id_unit like '%$jakarta%' or a.id_unit like '%$botabek%' or a.id_unit like '%$nsro%' or a.id_unit like '%$sulam%' or a.id_unit like '%$kalimantan%' or a.id_unit like '%$jabar%' or a.id_unit like '%$jatim%' or a.id_unit like '%$ssro%') 
				 	  			and  convert(varchar,a.date_saved,112) between '$tgl1' and '$tgl2'";
	   				}
					
	  			if ($report_by=="Observer")
				  	{				  
				 	 //$stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c,db_qm.dbo.table_qm_galeri a,assest_galeri.dbo.table_usr b  where a.status_save='complete'  and a.id_qm=c.id_qm and fcr='fcr' and a.userid=b.username and a.observer='$c_observer' and a.date_saved between '$date_eva1 00:00:00.000' and '$tgl2 23:59:59.000'";
					  $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c inner join db_qm.dbo.table_qm_galeri a
	  			...
	  			if ($report_by=="Agent")
				  	{				  
				 	 //$stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c,db_qm.dbo.table_qm_galeri a,assest_galeri.dbo.table_usr b  where a.status_save='complete'  and a.id_qm=c.id_qm and fcr='fcr' and a.userid=b.username and (a.userid='$nik_agent' or b.full_name like'%$nik_agent%') and a.date_saved between '$date_eva1 00:00:00.000' and '$tgl2 23:59:59.000'";
				 	  $stot_fcr="select count(*) as jum_s_fcr from db_qm.dbo.table_qm_galeri_detail c inner join db_qm.dbo.table_qm_galeri a
	...
	from db_qm.dbo.table_qm_galeri a with(nolock) 
   inner join db_qm.dbo.table_qm_galeri_detail b with(nolock) on a.id_qm=b.id_qm
...
select id_qm from (
					select a.id_qm,
					case when sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  >= 90 then 'A'
					when sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  >= 80 and sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  < 90 then 'B'
					when sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  >= 70 and sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  < 80 then 'C'
					when sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  >= 60 and sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)  < 70 then 'D'
					when sum ( save_q1+save_q2+save_q3+save_q4+save_q5+save_q6+save_q7+save_q8+save_q9+save_q10+save_q11+save_q12+save_q13+save_q14+save_q15+save_q16+save_q17)   < 60 then 'E' end 'Skala'
					from db_qm.dbo.table_qm_galeri a with(nolock) 
					inner join db_qm.dbo.table_qm_galeri_detail b with(nolock) on a.id_qm=b.id_qm 
    ...
    <tr>
      ...
      <td><?  
			...
			$stot_hh="[sp_handling11]'table_qm_galeri','$report_by','$tgl1','$tgl2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
					//echo $stot_hh;
