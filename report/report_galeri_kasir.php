...
newwindow=window.open(mylink,name,'width=1000,height=700,toolbar=0,menubar=0,location=0');  
...
$result11 = mssql_query( $query11 );
      ...
      <td><select name="skala_cmb" id="select" class="box"   >
...
$result2 	= mssql_query("SET ANSI_WARNINGS ON") or die(mssql_get_last_message());
 ...
 /*$itung="[sp_count3]'table_qm_galeri_kasir','$tgl1','$tgl2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
 */
 $itung="[sp_count3]'table_qm_galeri_kasir','$tgl1','$tgl2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$obs','%$nik_agent%','$select_region','$skala_cmb','$departemen_skala','$unit_skala'";
...
//echo "$q1_yes_jum";
	...
	{ ?>
	 <table width="368%" border="1" align="center" id="dyntable" cellspacing="1" class="table table-bordered table-infinite">
  <thead>
    <tr bgcolor="#CCCCCC">
	...
	<? 				
	/* $q_user="[sp_search3]'table_qm_galeri_kasir','$report_by','%$kd_unit%','$tgl1','$tgl2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
	*/
$q_user="[sp_search3]'table_qm_galeri_kasir','$report_by','%$kd_unit%','$tgl1','$tgl2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','','$skala_cmb','$departemen_skala','$unit_skala'";
...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
					  ...
					  <a href="<? echo "del_group.php?report_by=$report_by&kode_del=detail_galeri_kasir&id_qm=$id_qm&kd_division=$kd_division&kd_departemen=$kd_departemen&kd_unit=$kd_unit&date_eva1=$tgl1&date_eva2=$tgl2&c_observer=$observer"; ?>" onclick="return confirmDelete2();">
					  <?
					  	 echo "delete</a></td>";
	}
						 echo "<td>";
...
?>
					...
					<td><a href="showKalibrasi/show_galeri_kasir.php?id=<? echo "$id";?>&id_qm=<? echo "$id_qm";?>&agree=<? echo "$agree";?>" onClick="return popup(this, 'notes');">
					<? if ($id_kalibrasi != ""){
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
				 //edit hendi
      $queryhendi="[sp_reportqm11]'table_qm_galeri_kasir','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','%$kd_unit%','%%','$skala_cmb','$departemen_skala','$unit_skala'";
...
printf("%1.2f ", $prosen_q10_na);
  ...
  <table width="264" border="1" class="table table-bordered table-infinite">
    <tr>
      ...
      <td width="68">
      <? $nfe_total=$q1_tot_y+$q2_tot_y+$q6_tot_y+$q7_tot_y+$q8_tot_y+$q9_tot_y+
      $q10_tot_y+$q1_tot_na+$q2_tot_na+$q6_tot_na+$q7_tot_na+$q8_tot_na+$q9_tot_na+$q10_tot_na; 
      echo"$nfe_total";?></td>
    </tr>
    <tr>
      <td>NFE Accuracy</td>
    ...
    <tr>
      ...
      /*
		...
		$stot_fe="[sp_fetotalgalery11]'table_qm_galeri_kasir','$report_by','$tgl1','$tgl2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala_cmb','$departemen_skala','$unit_skala'";
			//echo"$stot_fe"	;	
    ...
    <tr>
      ...
      <td><?  /*
	   ...
	   while($d_stot_ss=mssql_fetch_array($r_stot_ss))
			...
			*/
			$stot_hh="[sp_handling11]'table_qm_galeri_kasir','$report_by','$tgl1','$tgl2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala_cmb','$departemen_skala','$unit_skala'";
					//echo $stot_hh;
	   $r_stot_hh=mssql_query($stot_hh);
	   while($d_stot_hh=mssql_fetch_array($r_stot_hh))
			{
