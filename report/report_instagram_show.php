...
<body>
	...
	?>
		  ...
		  $tgl2 = date('Ymd',strtotime($tgl2));
			...
			echo "&nbsp&nbsp$nbsp<a class='btn btn-warning' href='export_instagram_detail.php?id_pribadi_user=$id_pribadi_user&report_by=$report_by&kd_unit=$kd_unit&tgl1=$tgl1&tgl2=$tgl2&cc_mentari=$cc_mentari&cc_im3=$cc_im3&c_observer=$c_observer&nik_agent=$nik_agent&select_region=$select_region&skalacmb=$skalacmb&departemen_skala=$departemen_skala&unit_skala=$unit_skala'>export to excel</a>";
