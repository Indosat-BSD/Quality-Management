...
<body>
	...
	?>
		  ...
		  $tgl2 = date('Ymd',strtotime($tgl2));
			...
			echo "&nbsp&nbsp$nbsp<a class='btn btn-warning' href='export_detail.php?id_pribadi_user=$id_pribadi_user&report_by=$report_by&tgl1=$tgl1&tgl2=$tgl2&select_region=$select_region&st_rep=$st_rep&channel=$channel'>export to excel</a>";
