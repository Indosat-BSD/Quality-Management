...
header("Content-Disposition: attachment; filename=report_voce.xls"); 
...
<table width="368%" border="1" align="center" cellspacing="1">
  ...
  <?
	...
	$itung="[sp_countVoce]'table_qm_voce','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc1%','%$cc2%','%$cc3%','%$cr1%','%$cr2%','%$dc1%','%$dc2%','$c_observer','%$nik_agent%','$select_region'";
...
//echo "$q1_yes_jum";
					...
					$q_user="[sp_searchVoce]'table_qm_voce','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc1%','%$cc2%','%$cc3%','%$cr1%','%$cr2%','%$dc1%','%$dc2%','$c_observer','%$nik_agent%','$select_region'";
					//echo"$q_user";
 ...
 <table width="700" border="1" class="table table-bordered table-infinite">
  <thead>
    ...
    <tr>
      ...
      <td>
		<?  
		  $queryhendi="[sp_reportqm_voce]'table_qm_voce','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc1%','%$cc2%','%$cc3%','%$cr1%','%$cr2%','%$dc1%','%$dc2%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala'";
