...
<table width="368%" border="1" align="center" cellspacing="1">
  <tr bgcolor="#CCCCCC">
    ...
    <td colspan="3" class="header"><div align="center">Data Gathering</div></td>
    ...
    <td colspan="3" class="header"><div align="center">Human Touch</div></td>
    <td colspan="3" class="header"><div align="center">Voice Quality</div></td>
    <td colspan="3" class="header"><div align="center">Attitude during Handling</div></td>
    <td colspan="3" class="header"><div align="center">Empowerment</div></td>
    <td colspan="3" class="header"><div align="center">Communicating the Information</div></td>
    <td colspan="3" class="header"><div align="center">Negotiation skill</div></td>
    ...
    <? } ?>
    <td width="4%"  class="header"><div align="center">Observer</div></td>
    <td width="4%"  class="header"><div align="center">Validator</div></td>
  ...
  <tr bgcolor="#CCCCCC">
	...
	include "../konek_qm.php";
	 ...
	 $itung="[sp_count3]'table_qm_galeri','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
...
//echo "$q1_yes_jum";
	...
	if(($jum_tot<>"0") or ($kd_del=="ok"and $jum_tot<>"0"))
					...
					$q_user="[sp_search3]'table_qm_galeri','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
					//echo"$q_user";
...
//if ($repeat=="yes")
  ...
  <table width="568" border="1">
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm11]'table_qm_galeri','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','%$kd_unit%','%%','$skala','$departemen_skala','$unit_skala'";
...
printf("%1.2f ", $prosen_q17_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
		$stot_fe="[sp_fetotalgalery11]'table_qm_galeri','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
...
select id_qm from (
    ...
    <tr>
      ...
      <td><?  
			...
			$stot_hh="[sp_handling11]'table_qm_galeri','$report_by','$date_eva1','$date_eva2','$kd_unit','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%','$skala','$departemen_skala','$unit_skala'";
					//echo $stot_hh;
