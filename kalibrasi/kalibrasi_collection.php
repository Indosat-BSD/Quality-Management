...
$r_observerCombo = mssql_query( $q_observerCombo );
  ...
  <thead>
	...
	if ($date_eva1 != "" && $date_eva2 != "") {
		...
		$itung="[sp_countAdd_kalibrasi_cole]'table_qm_collection','$tgl1','$tgl2','$report_by','%$kd_unit%','$cc_mentari','$cc_im3','$obs','%$nik_agent%','$select_region','$st_rep'";
...
//echo "$q1_yes_jum";
	...
	if((isset($searchButton) and $jum_tot<>"0") or ($kd_del=="ok"and $jum_tot<>"0"))
					...
					$q_user="[sp_searchAdd_kalibrasi_cole]'table_qm_collection','$report_by','%$kd_unit%','$tgl1','$tgl2','$cc_mentari','$cc_im3','$c_observer','%$nik_agent%','$select_region','$st_rep'";
					//echo $q_user;
					//echo "456456";
...
<tr onMouseOver="this.style.cursor='hand'; this.style.backgroundColor='#E8E6FF';" onMouseOut="this.style.backgroundColor='#FFFFFF';">	
		<td><a href="<? echo "kalibrasi/add_kalibrasi_collection.php?id_qm=$id_qm&observer=$observer&kd_unit=$kd_unit&id_pribadi_user=$id_pribadi_user&id_lb=$lb"; ?>" onClick="return popup(this, 'notes');"><? echo $no;?></a></td> 
