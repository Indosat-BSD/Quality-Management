...
<thead>
    <tr bgcolor="#CCCCCC">
      <th class="head0"><div align="center">Form Input Process Level</div></th>
    </tr>
</thead>
...
<table>
    ...
    <tr>
      ...
      <td><input name="hh_it" type="text" id="hh_it" value="<? echo"$hh_it"; ?>" size="2" maxlength="2" class="input-small">
:
  <input name="mm_it" type="text" id="mm_it" value="<? echo"$mm_it"; ?>" size="2" maxlength="2" class="input-small">
  (hh:mm) </td>	  
    </tr>
	<tr>
...
<?
		  ...
		  if ($Submit)
	  {
		...
		$interaction_time="$hh_it$slas$mm_it";
			$add="insert into table_kalibrasi_pl(id_qm,msisdn,customer_name,interaction_date,interaction_time,observation_date,hh_duration,mm_duration,ss_duration,week_,interaction_type,product_knowledge,notes_pk,activity_code,notes_ac,handling_process,fcr,notes_fcr,repeat,notes_repeat,antusiasm,notes_antusiasm,manner,notes_manner,effective_handling,notes_eh,notes_score,id_kalibrasi,kd_unit,id_pribadi_observer,id_pribadi_user,date_saved) values('$id_qm','$msisdn','$customer_name','$interaction_date','$interaction_time','$observation_date','$hh_2','$mm_2','$ss_2','$week_','$interaction_type','$product_knowledge','$notes_pk','$activity_code','$notes_ac','$handling_process','$fcr','$notes_fcr','$repeat','$notes_repeat','$anthusiasm','$notes_anthusiasm','$manner','$notes_manner','$effective_handling','$notes_eh','$notes_score','$SES_hendi','$kd_unit','$observer','$id_pribadi_user',getdate())";
			mssql_query($add);
			//echo "$add";
