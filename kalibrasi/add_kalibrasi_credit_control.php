...
<thead>
  ...
  NA</td>
    ...
    <tr>
      <td>2</td>
      <td>NCE</td>
      <td>Permission and purpose to call </td>
...
20      </div></td>
  ...
  NA</td>
    ...
    <tr>
      <td>5</td>
      <td>CE</td>
      <td>Approval Verification Prosess</td>
      <td><div align="center">20</div></td>
...
<?
 //nfe total
$nfe_total=$q1_tot_y+$q2_tot_y+$q3_tot_y+$q7_tot_y+$q8_tot_y+$q9_tot_y+$q10_tot_y+$q11_tot_y+$q1_tot_na+$q2_tot_na+$q3_tot_na+$q7_tot_na+$q8_tot_na+$q9_tot_na+$q10_tot_na+$q11_tot_na;
...
<?
		  ...
		  if ($Submit)
	  {
		...
		if($q3=="" or $q1=="" or $q2==""  or $q4=="" or $q5=="" or $q6=="" or $q7=="" or $q8=="" or $q9=="" or $q10=="" or $q11=="" or $spv_name=="" or $interaction_date=="" or $observation_date=="" or $week_=="0" or $customer_name=="" or $interaction_type=="0" or $product_type=="" or $product_detail=="" or $product_detail_agent==""  or $call_activity=="0" or hh_2=="" or $mm_2=="" or $ss="" or $call_status=="0" or $agree=="")
		{
		...
		$c ="select * from table_kalibrasi_credit_control where id_qm='$id'";
		$q = mssql_query($c);
		$n = mssql_num_rows($q);
		
		if ($n <= 0) {
			$add="insert into table_kalibrasi_credit_control(notes1,notes2,notes3,notes4,notes5,notes6,notes7,notes8,notes9,notes10,notes11,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,save_q1,save_q2,save_q3,save_q4,save_q5,save_q6,save_q7,save_q8,save_q9,save_q10,save_q11,status_save,id_pribadi_user,id_pribadi_observer,date_saved,tot_score,id_unit,lb,id_qm,notes_score,id_kalibrasi)
		  values('$notes1','$notes2','$notes3','$notes4','$notes5','$notes6','$notes7','$notes8','$notes9','$notes10','$notes11','$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$q9','$q10','$q11','$save_q1','$save_q2','$save_q3','$save_q4','$save_q5','$save_q6','$save_q7','$save_q8','$save_q9','$save_q10','$save_q11','complete','$id_pribadi_user','$observer',getdate(),'$save_total','$kd_unit','$id_lb','$id','$notes_score','$SES_hendi')";
			mssql_query($add);
		echo "$add";
		 
		 
		 $date_saved=date("m/d/Y H:i:s");		  
		 $add2="update table_qm_credit set id_kalibrasi='$SES_hendi', kalibrasi='$agree' where id_qm='$id'";
		  mssql_query($add2);
		  //echo "$q_addTemp";
		}
		  //echo "$q_addTemp";
