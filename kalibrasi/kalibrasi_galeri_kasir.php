...
$result2 	= mssql_query("SET ANSI_WARNINGS ON") or die(mssql_get_last_message());
 ...
 $itung="[sp_countAdd_kalibrasi]'table_qm_galeri_kasir','$tgl1','$tgl2','$report_by','%$kd_unit%','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%',''";
...
//echo "$q1_yes_jum";
  ...
  <thead>
	...
	<? 				
					$q_user="[sp_searchAdd_kalibrasi]'table_qm_galeri_kasir','$report_by','%$kd_unit%','$tgl1','$tgl2','%$bali%','%$jateng%','%$jakarta%','%$botabek%','%$nsro%','%$sulam%','%$kalimantan%','%$jabar%','%$jatim%','%$ssro%','$c_observer','%$nik_agent%',''";
					//echo"$q_user";
