...
$r_observerCombo = mssql_query( $q_observerCombo );
  ...
  <thead>
	...
	$itung="[sp_countAdd_kalibrasi]'table_qm','$tgl1','$tgl2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$select_channel'";
...
//echo "$q1_yes_jum";
	...
	if((isset($searchButton) and $jum_tot<>"0") or ($kd_del=="ok"and $jum_tot<>"0"))
					...
					$q_user="[sp_searchAdd_kalibrasi]'table_qm','$report_by','%$kd_unit%','$tgl1','$tgl2','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$select_channel'";
					//echo $q_user;
					//echo "456456";
...
<tr onMouseOver="this.style.cursor='hand'; this.style.backgroundColor='#E8E6FF';" onMouseOut="this.style.backgroundColor='#FFFFFF';">	
		<!--<td><a href="<? echo "kalibrasi/add_kalibrasi_inbound.php?&id_qm=$id_qm&full_name=$full_name&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&repeat=$repeat&date_prev_call=$date_prev_call2&prev_agent=$prev_agent&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&drop_call=$drop_call&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&notes9=$notes9&notes10=$notes10&notes11=$notes11&notes12=$notes12&notes13=$notes13&notes14=$notes14&sc1=$q1&sc2=$q2&sc3=$q3&sc4=$q4&sc5=$q5&sc6=$q6&sc7=$q7&sc8=$q8&sc9=$q9&sc10=$q10&sc11=$q11&sc12=$q12&tot1=$save_q1&tot2=$save_q2&tot3=$save_q3&tot4=$save_q4&tot5=$save_q5&tot6=$save_q6&tot7=$save_q7&tot8=$save_q8&tot9=$save_q9&tot10=$save_q10&tot11=$save_q11&tot12=$save_q12&observer=$observer&date_saved=$date_saved&total_score=$score_tot&skala=$skala2&kd_unit=$kd_unit&id_pribadi_user=$id_pribadi_user&channel=$select_channel"; ?>" onClick="return popup(this, 'notes');"><? echo $no;?></a></td>-->
		<td><a href="<? echo "kalibrasi/add_kalibrasi_inbound.php?&id_qm=$id_qm"; ?>" onClick="return popup(this, 'notes');"><? echo $no;?></a></td>
	<?		    echo"<td>$area</td>
					  <td>$userid</td>
                      <td>$region</td>
					  <td>$lb</td>
