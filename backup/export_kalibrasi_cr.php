...
<table width="368%" border="1" align="center" cellspacing="1">
  <tr bgcolor="#CCCCCC">
    ...
    <td width="2%" rowspan="2" class="head0">Validation Date</td>
...
<table width="568" border="1">
  ...
  <tr>
      ...
      //edit hendi
      $queryhendi=
"[sp_reportqm_kalibrasi_cole]'table_kalibrasi_cr','table_qm_cr','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$kd_unit%','%%','$select_region','$st_rep'";
  ...
  <table width="264" border="1">
    ...
    <tr>
      ...
      <td><?  
		...
		$stot_fe=
"[sp_fetotal_kalibrasi_cole]'table_kalibrasi_cr','table_qm_cr','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
...
<? }else{ //menampilkan data baru?>  
	...
	<th colspan="3" class="head0"><div align="center">Opening Greeting</div></td>
      <td colspan="3" class="head0"><div align="center">Confirmation Customer Data</div></td>
      <td colspan="3" class="head0"><div align="center">Identifikasi Kebutuhan Pelanggan</div></td>
      ...
      <td colspan="3" class="head0"><div align="center">Input Accuracy Data</div></td>
      ...
      <td colspan="3" class="head0"><div align="center">Hold</div></td>
      <td colspan="3" class="head0"><div align="center">Reconfirm</div></td>
      ...
      <td width="4%" rowspan="2" class="head0"><div align="center">CE Accuracy </div></td>
      <td width="4%" rowspan="2" class="head0"><div align="center">NCE Accuracy </div></td>
      <td width="4%" rowspan="2" class="head0"><div align="center">Total Score </div></td>
      <td width="4%" rowspan="2" class="head0"><div align="center">Skala</div></td>
      <td width="4%" rowspan="2" class="head0">Recommendation</td>
      <td width="4%" rowspan="2" class="head0"><div align="center">Observer</div></td>
      <td width="4%" rowspan="2" class="head0"><div align="center">Validation</div></td>
  ...
  <table width="264" border="1">
    ...
    <tr>
      ...
      <td><?  
		...
		$stot_fe="[sp_fetotal_kalibrasi_cole]'table_kalibrasi_cr','table_qm_cr','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
	   $r_stot_fe=mssql_query($stot_fe);
	   while($d_stot_fe=mssql_fetch_array($r_stot_fe))
			{
		     	$fe_tot=$d_stot_fe["jum_fe_tot"];
