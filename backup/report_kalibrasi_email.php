...
function confirmDelete2()
{
    return confirm('Are you sure you wish to delete this entry?');
					...
					$observname=$qqq["observer_name"];
					  ...
					  <a href="<? echo "edit_kalibrasi/edit_kalibrasi_email.php?st_rep=$st_rep&kode_edit=edit_email&id=$id&activity_code=$activity_code&id_qm=$id_qm&tenure=$tenure&full_name=$full_name&call_activity=$call_activity&call_status=$call_status&spv_name=$spv_name&observer_name=$observname&interaction_date=$interaction_date2&hh=$hh&mm=$mm&observation_date=$observ&week_=$week_&customer_name=$customer_name&interaction_type=$interaction_type&product_type=$product_type&product_detail=$product_detail&product_detail_agent=$product_detail_agent&fcr=$fcr&repeat=$repeat&date_prev_call=$date_prev_call&prev_agent=$prev_agent&recommendation=$recommendation&hh_2=$hh_2&mm_2=$mm_2&ss_2=$ss_2&drop_call=$drop_call&notes1=$notes1&notes2=$notes2&notes3=$notes3&notes4=$notes4&notes5=$notes5&notes6=$notes6&notes7=$notes7&notes8=$notes8&notes9=$notes9&notes10=$notes10&notes11=$notes11&notes12=$notes12&notes13=$notes13&notes14=$notes14&notes15=$notes15&notes16=$notes16&notes17=$notes17&notes18=$notes18&notes19=$notes19&notes20=$notes20&q1=$q1&q2=$q2&q3=$q3&q4=$q4&q5=$q5&q6=$q6&q7=$q7&q8=$q8&q9=$q9&q10=$q10&q11=$q11&q12=$q12&q13=$q13&q14=$q14&userid=$userid&observer=$SES__NIK&date_saved=$date_saved&fe_acc=$sc_fe&nfe_acc=$sc_nfe&total_score=$total_score&skala=$skala&notes_score=$notes_score&agree=$agree"; ?>" onClick="return popup(this, 'notes');">	
...
//
  ...
  <thead>
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
      $queryhendi="[sp_reportqm_kalibrasi_cole]'table_kalibrasi_email','table_qm_email','$tgl1','$tgl2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$kd_unit%','%%','$select_region','$st_rep'";
	  //echo $queryhendi;
...
printf("%1.2f ", $prosen_q14_na);
  ...
  <table border="1"  class="table table-bordered table-infinite">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
		$stot_fe="[sp_fetotal_kalibrasi_cole]'table_kalibrasi_email','table_qm_email','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
    ...
    <tr>
      ...
      <td><?  
			$stot_hh="[sp_handling_kalibrasi_cole]'table_kalibrasi_email','table_qm_email','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_mentari%','%$cc_im3%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
			//echo $stot_hh;
