...
<table width="368%" border="1" align="center" cellspacing="1">
  ...
  <?
	...
	$itung="[sp_count3]'table_qm_newHireIB','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
...
<table width="568" border="1">
  <tr bgcolor="#CCCCCC">
    ...
    <tr>
	  ...
	  <td>3</td>
      <td><?  
	  //edit hendisp_reportqm_newhire
      $queryhendi="[sp_reportqm_newhire]'table_qm_newHireIB','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$depart','$unitSkala','1'";
