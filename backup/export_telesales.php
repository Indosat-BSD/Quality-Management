...
<? if ($st_rep =='1'){ //menampilkan data lama?> 
  ...
  <?
	include "../konek_qm.php";
	 ...
	 $itung="[sp_count_telesales]'table_qm_telesales','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
	 //echo $itung;
	 $queryitung=mssql_query($itung);
	 $hasilitung=mssql_fetch_array($queryitung);
	 $jum_tot=$hasilitung["jum_s"];

					 $q_user="[sp_search_telesales]'table_qm_telesales','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
					//echo"$q_user";
...
<table width="568" border="1">
  ...
  <tr>
      ...
      <td><?  
	   ...
	   $queryyanti="[sp_reportqm_telesales]'table_qm_telesales','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_tele%','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
...
printf("%1.2f ", $prosen_q19_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      <td>FE Total </td>
      <td><?  
		$stot_fe="[sp_fetotal_telesales]'table_qm_telesales','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$st_rep'";
...
printf("%1.2f ", $prosen_q13_na);
      ...
      <td width="68"><? $nfe_total=$q1_tot_y+$q2_tot_y+$q6_tot_y+$q7_tot_y+$q8_tot_y+$q9_tot_y+$q10_tot_y+$q11_tot_y+$q12_tot_y+$q13_tot_y+$q1_tot_na+$q2_tot_na+$q6_tot_na+$q7_tot_na+$q8_tot_na+$q9_tot_na+$q10_tot_na+$q11_tot_na+$q12_tot_na+$q13_tot_na; echo"$nfe_total";?></td>
    </tr>
    <tr>
      <td>NCE Accuracy</td>
      <td><?
...
<? } ?>
    <tr>
      ...
      <td><?  
			$stot_hh="[sp_handling_telesales]'table_qm_telesales','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_tele%','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
