...
<? if ($st_rep =='1'){ //menampilkan data lama?>  
      <td colspan="3" class="header"><div align="center">Greeting user account name</div></td>
      <td colspan="3" class="header"><div align="center">Verify and Identify customer needs</div></td>
      ...
      <td colspan="3" class="header"><div align="center">Ethics  and twitter handling</div></td>
      <td colspan="3" class="header"><div align="center">Approriate words, acronym and punctuation</div></td>
      <td colspan="3" class="header"><div align="center">Human touch and manner</div></td>
      <td colspan="3" class="header"><div align="center">Agent Initial</div></td>
...
$sc_nfe=$sc_q1+$sc_q2+$sc_q3+$sc_q7+$sc_q9+$sc_q10+$sc_q11+$sc_q12;
...
$sc_nfe=$sc_q1+$sc_q2+$sc_q7+$sc_q9+$sc_q10+$sc_q11+$sc_q12;
 					 	$total_score=$save_q1+$save_q2+$save_q4+$save_q5+$save_q6+$save_q7+$save_q8+$save_q9+$save_q10+$save_q11+$save_q12;
						if ($total_score >= 90)
						{
						$skala="A";
						}
...
//
  ...
  <table width="568" border="1">
    ...
    <tr>
      ...
      <td><?  
				  //edit hendi
     $queryhendi="[sp_reportqm_colection]'table_qm_twitter','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','$cc_mentari','$cc_im3','%$kd_unit%','%%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
...
printf("%1.2f ", $prosen_q12_na);
  ...
  <table width="264" border="1">
    <tr>
      ...
      <td width="68"><? $nfe_total=$q1_tot_y+$q2_tot_y+$q7_tot_y+$q9_tot_y+$q10_tot_y+$q11_tot_y+$q12_tot_y+$q1_tot_na+$q2_tot_na+$q7_tot_na+$q9_tot_na+$q10_tot_na+$q11_tot_na+$q12_tot_na; echo"$nfe_total";?></td>
    </tr>
    <tr>
      <td>NFE Accuracy</td>
      <td><?
    ...
    <tr>
      ...
      /*
	  			if ($report_by=="Unit")
				  	{				  
				 	 $stot_fe="select count(*) as jum_fe_tot from db_qm.dbo.table_qm_twitter a,dev_asst3.dbo.table_usr b ,db_qm.dbo.table_qm_twitter_detail c where a.id_qm=c.id_qm and  a.status_save='complete' and  a.q4<>'no' and  a.q5<>'no' and  a.q6<>'no' and  a.q8<>'no' and a.userid=b.username and a.kd_unit like '%$kd_unit%' and a.date_saved between '$date_eva1 00:00:00.000' and '$date_eva2 23:59:59.000'"; 
					}
	  			if ($report_by=="Departement")
				  	{				  
				 	 $stot_fe="select count(*) as jum_fe_tot from db_qm.dbo.table_qm_twitter a,dev_asst3.dbo.table_usr b ,db_qm.dbo.table_qm_twitter_detail c where a.id_qm=c.id_qm and  a.status_save='complete' and  a.q4<>'no' and  a.q5<>'no' and  a.q6<>'no' and  a.q8<>'no' and a.userid=b.username and (a.kd_unit like '%$cc_mentari%' or a.kd_unit like '%$cc_im3%' or a.kd_unit like '%$cc_pp%' or a.kd_unit like '%$cc_matrix%' or a.kd_unit like '%$cc_ftm%' or a.kd_unit like '%$cc_m2%') and a.date_saved between '$date_eva1 00:00:00.000' and '$date_eva2 23:59:59.000'"; 
					}
					
	  			if ($report_by=="Observer")
				  	{				  
				 	// $stot_fe="select count(*) as jum_fe_tot from db_qm.dbo.table_qm a,dev_asst.dbo.table_usr b ,db_qm.dbo.table_qm_detail c where a.id_qm=c.id_qm and  a.status_save='complete' and  a.q4<>'no' and  a.q5<>'no' and  a.q6<>'no' and a.q20<>'no' and a.userid=b.username and a.observer='$c_observer' and a.date_saved between '$date_eva1 00:00:00.000' and '$date_eva2 23:59:59.000'";
				 	$stot_fe="select count(*) as jum_fe_tot from db_qm.dbo.table_qm_cr a
								inner join db_qm.dbo.table_qm_cr_detail c on a.id_qm=c.id_qm
								inner join hrms.dbo.tb_data_pribadi z on a.id_pribadi_observer=cast(id_data_pribadi as varchar)
								where a.status_save='complete' and  a.q4<>'no' and  a.q5<>'no' and  a.q6<>'no' and a.q20<>'no'
								and cast(id_data_pribadi as varchar)='$c_observer'
								and convert(varchar,a.date_saved,101) between convert(varchar,'$date_eva1',101) and convert(varchar,'$date_eva2',101)";  
					}
					
	  			if ($report_by=="Agent")
				  	{				  
				 	 $stot_fe="select count(*) as jum_fe_tot from db_qm.dbo.table_qm_twitter a,dev_asst3.dbo.table_usr b ,db_qm.dbo.table_qm_twitter_detail c where a.id_qm=c.id_qm and  a.status_save='complete' and  a.q4<>'no' and  a.q5<>'no' and  a.q6<>'no' and  a.q8<>'no' and a.userid=b.username and (a.userid='$nik_agent' or b.full_name like'%$nik_agent%') and a.date_saved between '$date_eva1 00:00:00.000' and '$date_eva2 23:59:59.000'"; 
					}
					*/
		$stot_fe="[sp_fetotal_colection]'table_qm_twitter','$report_by','$date_eva1','$date_eva2','$kd_unit','$cc_mentari','$cc_im3','$c_observer','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala','$st_rep'";
      ...
      <td><?  
	  			...
	  			if ($report_by=="Departement")
					  ...
					  $stot_r="select count(*) as jum_s_r from db_qm.dbo.table_qm_twitter_detail c inner join db_qm.dbo.table_qm_twitter a
					  			on a.id_qm=c.id_qm where a.status_save='complete' and repeat='yes'  and (a.id_unit like '%$cc_mentari%' or a.id_unit like '%$cc_im3%' or a.id_unit like '%$cc_pp%' or a.kd_unit like '%$cc_matrix%' or a.id_unit like '%$cc_ftm%' or a.id_unit like '%$cc_m2%')
					  			and  convert(varchar,a.date_saved,112) between '$date_eva1' and '$date_eva2' and a.flag_status='$st_rep'";  
	  				}
...
select id_qm from (
    ...
    <tr>
      <td>Score Average</td>
      <td>	  <?
	  $score_avg=$q1_avg+$q2_avg+$q4_avg+$q5_avg+$q6_avg+$q7_avg+$q8_avg+$q9_avg+$q10_avg+$q11_avg+$q12_avg;
	  //echo"$score_avg";
