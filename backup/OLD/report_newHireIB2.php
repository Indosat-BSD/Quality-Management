...
";   
    ...
    <tr>
      ...
      <td width="68">
		<?  
					if($c_observer==""){$obs="%%";}else{$obs=$c_observer;}
					$stot_hh="[sp_handling3]'table_qm_newHireIB','$report_by','$tgl1','$tgl2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$obs','%$nik_agent%','$select_region','$skala','$departemen_skala','$unit_skala'";
			//echo"$stot_hh";
