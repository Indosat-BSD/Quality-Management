...
header("Content-Disposition: attachment; filename=report_inbound.xls"); 
...
<table width="368%" border="1" align="center" cellspacing="1">
  ...
  <?
	...
	$itung="[sp_count3]'table_qm','$date_eva1','$date_eva2','$report_by','%$kd_unit%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
...
//echo "$q1_yes_jum";
					...
					$q_user="[sp_search3]'table_qm','$report_by','%$kd_unit%','$date_eva1','$date_eva2','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
					//echo"$q_user";
...
<table width="568" border="1">
 ...
 <tr>
      ...
      <td><?  
	  //edit hendi
      $queryhendi="[sp_reportqm3]'table_qm','$date_eva1','$date_eva2','$report_by','$c_observer','%$nik_agent%','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%-%','%-%','%-%','%-%','%-%','%-%','%-%','%$kd_unit%','%%','$select_region','$skala','$depart','$unitSkala'";
...
printf("%1.2f ", $prosen_q14_na);
  ...
  <table width="264" border="1">
    ...
    <tr>
      <td>CE Total </td>
      <td><?  
					$stot_fe="[sp_fetotal_ib2]'table_qm','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
					//echo $stot_fe;
...
";   
    ...
    <tr>
      ...
      <td><?  
					$stot_hh="[sp_handling3]'table_qm','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','%-%','%-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
					//echo $stot_hh;
    ...
    <tr>
      <td>Drop Call (Y) </td>
      <td><?  
	   $stot_d="[sp_dropcall3]'table_qm','$report_by','$date_eva1','$date_eva2','$kd_unit','%$cc_mentari%','%$cc_im3%','%$cc_pp%','%$-%','%-%','%-%','$c_observer','%$nik_agent%','$select_region','$skala','$depart','$unitSkala'";
	   //echo $stot_d;
